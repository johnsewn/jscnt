...
function _aMC(e) {
    for (var t = e,
    i = -1; t = t.parentNode;) if (i = parseInt(t.getAttribute("id")), i > 0) return i
}
function al_c(e) {
    for (;
...
function c(e) {
    var t = e.p1;
    if (! ("alop" != e.fm || "rsv_xpath" in e || t && "6677" == G(t).getAttribute("srcid"))) return ! 0; ! t || "p5" in e || (e.p5 = t);
    ...
    for (v in e) {
        ...
        case "title":
            o = e[v].replace(/<[^<>]+>/g, ""),
            o && o.length > 100 && (o = o.substring(0, 100)),
...
function ns_c_pj(e, t) {
    ...
    if (s = "&mu=" + i, src = nsclickDomain + "/v.gif?pid=201&" + (t || "") + n + "path=" + i + "&wd=" + wd + "&rsv_sid=" + (bds.comm.ishome && bds.comm.indexSid ? bds.comm.indexSid: bds.comm.sid) + "&rsv_did=" + r + "&t=" + (new Date).getTime(), "undefined" != typeof Cookie && "undefined" != typeof Cookie.get) Cookie.get("H_PS_SKIN") && "0" != Cookie.get("H_PS_SKIN") && (src += "&rsv_skin=1");
    else {
        var a = "";
        try {
...
function initPreload(e) {
    ...
    function i(e, t) {
        t = t || 3,
        Cookie.set("ISWR", e, null, null, new Date((new Date).getTime() + 1e3 * t))
    }
    function n(e) {
        e && "string" == typeof e && (e = $.parseJSON(e)),
        e && e.length && $.each(e,
        function(e, t) {
    ...
    function r(e) {
        var t, i, n, o, s = {};
        e.indexOf("?") > -1 ? (n = e.split("?"), o = n[1]) : o = e,
        t = o.indexOf("&") > -1 ? o.split("&") : new Array(o);
        for (var r = 0; r < t.length; r++) try {
            t[r] = t[r].indexOf("=") > -1 ? t[r] : t[r] + "=",
            i = t[r].split("="),
            s[i[0]] = decodeURIComponent(i[1].replace(/\+/g, " "))
        } catch(a) {}
        return s
    }
    function a(e) {
        ...
        function i() {
            ...
            Q || (t(".slowmsg{z-index:301;background-color:#fff;border:1px solid #f0f0f0;position:fixed;_position:absolute;top:144px;left:212px;height:95px;width:360px;box-shadow:0 0 5px rgba(0,0,0,0.05)}.slowmsg .ball{width:40px;margin:41px auto 0;position:relative;}.slowmsg .b{left:20px;position:absolute;width:10px;height:10px;-moz-border-radius: 50%;-webkit-border-radius: 50%;border-radius: 50%;}"), Q = $('<div class="slowmsg"><div class="ball"><div class="b"/><div class="b"/><div class="b"/></div></div>'), Q.find(".b").each(function(e, t) {
                var i = [[0, 40], [20, 20], [40, 0]][e],
        ...
        function n() {
            ...
            Cookie.set("rsv_jmp_slow", t),
            Cookie.set("WWW_ST", t, null, null, new Date(t + 3e4)),
            e = lt.href + (lt.href.indexOf("?") > 0 ? "&": "?") + "rsv_jmp=slow",
            lt.replace(e)
        }
        if (!Z) {
            var o = 112,
            ...
            Z = !0,
            V.width(ai.width()),
            V.height(Math.max(s, ai.height()) - e.top),
            V.appendTo(ai),
            $(window).scrollTop(),
            J = setTimeout(i, 3e3),
            K = setTimeout(n, 7e3),
            Y = function() {
                J && (clearTimeout(J), J = setTimeout(i, 3e3)),
                K && (clearTimeout(K), K = setTimeout(n, 7e3))
            }
        }
    }
    function d() {
        V && Z && (Z = !1, V.remove(), Q && Q.remove(), J && (clearTimeout(J), J = !1), X && X.remove(), K && (clearTimeout(K), K = !1))
    }
    function l(e, t, i) {
        i || (i = 0);
        var n = e.length;
    ...
    function u(e, t, i) {
        ...
        "insertBefore" == i ? t.insertBefore(e) : "insertAfter" == i ? t.insertAfter(e) : e.append(t),
    ...
    function m(e) {
        try {
            ...
            window.console && console.debug && console.debug(t),
            et(t.toString())
        }
    }
    function p(e, t) {
        ...
        if (!p.__init) {
            ...
            p.prototype.p = function(e, t) {
                return l(s, e) >= 0 && (e = "wd"),
                void 0 === t ? this.params[e] : (this.params[e] = t, this)
            },
        ...
        if (this.params = {},
        !t) {
            Bt = St.serializeArray();
            for (var r = 0; r < Bt.length; r++) this.p(Bt[r].name) || this.p(Bt[r].name, Bt[r].value)
        }
    ...
    function f(e) {
        ...
        function a() {
            i("qid", e.qid),
            i("cus_q", e.real_wd || e.env.p("wd")),
            i("sid", bds.comm.sid),
            i("cus_newindex", bds.comm.newindex),
        ...
        function d(e) {
            k[e].resolve(),
            "swap_end" == e && setTimeout(function() {
                d("swap_end_5s")
            },
            5e3)
        }
        ...
        function m() {
            ...
            if (e > .51 && .52 > e || t.test(bds.comm.sid) && e > 0 && .2 > e || bds.comm.intrSid || r) {
                t.test(bds.comm.sid) && (s ? i("issam", 2) : i("issam", 1)),
                r && (i("issam", 3), i("bfesam", bds.comm.bfe_sample)),
                n(),
                h(T),
                b(T),
                i("srvInfo", f()),
                i("sysv", navigator.appMinorVersion),
                a(),
                x.fire();
        ...
        function h(e) {
            for (var t = 0,
            n = e.find("img"), o = e.find("#content_left").find("img"), s = 0, r = 0, a = 0; a < n.length; a++) r = n.eq(a).offset().top,
            D > r && r > 0 && t++;
            i("cus_ic", n.length),
            i("cus_extic", t),
            i("cus_extlic", s),
            i("cus_icl", o.length),
            i("cus_icr", e.find("#content_right").find("img").length),
            i("img_info", y.join(",")),
            i("psize", e.html().length)
        }
        function b(e) {
            var t = {},
            n = [],
            ...
            s = "";
            if (o.length > 0) for (var r = 0; r < o.length; r++) s = o.eq(r).attr("tpl"),
            t.hasOwnProperty(s) || (t[s] = 1, n.push(s));
    ...
    function b(e, t) {
        ...
        if (! (window.__sam_his_nopredict && window.bds && bds.comm && 0 == bds.comm.supportis)) {
            if (i || (i = At.val()), T(""), F(), clearTimeout(ei), clearTimeout(fi), 0 == pageState && window.__disable_index_predict || pt || ht || Zt.isSlow()) return void e.setMaxNum(10);
            e.setMaxNum(ct);
            var o = new p({
                pn: "",
                wd: t.value
            });
            if (bds && bds.comm && bds.comm.logFlagSug && 1 === bds.comm.logFlagSug && o.p("rsv_slog", "ipt_change"), 0 == pageState && bds.comm.supportis && $.trim(At.val())) {
                H(o);
            ...
            if (Vt) return void(Vt = !1);
            if (window.__restart_confirm_timeout && j(), Yt = "input", jt = (new Date).getTime(), n && (clearTimeout(n), n = !1), "" == $.trim(t.value)) return void D();
            if (Gt = t.checkStore(), !/^[a-zA-Z0-9~!@#$%^&*()_+=-]$/.test(t.value)) {
                ...
                !window.__disable_is2 && i.length > r.length && 0 === i.indexOf(r) ? n = setTimeout(function() {
                    O({
                        env: o,
                        use_cache: !0,
                        force: !1,
    ...
    function g(e, t, i, n) {
        if (T(""), clearTimeout(ei), !(0 == pageState && window.__disable_index_predict || pt || ht || Zt.isSlow())) if ( - 1 == t) {
    ...
    function v(e, t) {
        var i = getCursortPosition(this); (9 == t.keyCode || 39 == t.keyCode && i == (this.value && this.value.length)) && bds.comm.supportis && Jt && Et.text() && (t.preventDefault(), Jt.real_wd != this.value && (At.val(Jt.real_wd), e.check()), e.show(), T(""), R(Jt, Kt, 22)({
            tipConfirm: !0
        }))
    }
    function w(e) {
    ...
    function y() {
        if (bds.comm.seinfo) {
            ...
            if (bds && bds.comm && bds.comm.personalData) try {
                ...
                e = bds.comm.personalData ? bds.comm.personalData.fullSkinName && bds.comm.personalData.fullSkinName.value: null
            } catch(t) {
                e = null
            }
            if (e && (bds.comm.seinfo.rsv_skin = e), bds.comm.seinfo.rsv_psid = $.getCookie("BIDUPSID"), bds.comm.seinfo.rsv_pstm = $.getCookie("PSTM"), bds.comm.seinfo.rsv_idc = function() {
                ...
                for (var i = 0,
                n = e.length; n > i; i++) if (9540 == e[i].ModuleId) return e[i].Idc || "";
                return ""
        ...
        function() {
            ...
            t = function() {
                function e() {
                    ...
                    for (var s in i) !
                    function(t) {
                        var s = "_SSL_LOG_" + t + "_" + +new Date,
                        r = new Image,
                        a = new Date;
                        o[t] = $.Deferred(),
                        n.push(o[t]),
                        r.onload = function() {
                            e.push(t + "_success=" + (new Date - a)),
                            o[t].resolve(),
                            delete window[s]
                        },
                        r.onerror = function() {
                            e.push(t + "_error=" + (new Date - a)),
                            o[t].resolve(),
                            delete window[s]
                        },
                        r.src = i[t]
    ...
    function T(e) {
        if (!window.__disable_is2 || $.trim(e) != $.trim(At.val())) {
            if (ci || !bds.comm.supportis) return void(Et && Et.html(""));
            if (0 != pageState && !window.__disable_kw_tip) if (Et || (Et = $('<div id="kw_tip" style="width:initial" unselectable="on" onselectstart="return false;" class="s_ipt_tip"/>').insertBefore(At), Et.parent().click(function(e) {
                var t = At.get(0);
                ...
                window.__disable_is2 && Et.css("z-index", 1),
                Et.show()
            } else Et.hide()
        }
    }
    ...
    function D() {
        ci = !0,
        Jt && Jt.real_wd && $.trim(At.val()) ? (T(Jt.real_wd), I(Jt)) : (T(""), I())
    }
    function I(e) {
        var t = o(At.val());
    ...
    function L(e, t) {
        ...
        if (t.force || _(t, {
            utime: (new Date).getTime() - zt
        }), !t || !t.loaded) return ! 1;
        "string" == typeof t.html && (t.html = $(t.html)),
        $(t).trigger("swap_begin"),
        m(function() {
            t.pdc.mark("pt"),
            $(window).trigger("swap_begin", [t, e]);
            var i = Zt && Zt.getData();
        ...
        Kt = Jt,
        Jt = t,
        bds.comm.cur_disp_query = e.p("wd"),
        E(),
        ...
        m(function() {
            ...
            if (e.size()) {
                var t = $("#s_tab");
                t.size() ? t.replaceWith(e) : e.insertBefore(qt)
            }
        });
        var r = !1; !
        function() {
            ...
            if (n.size()) if (e.children().size()) {
                ...
                n.attr("cq") != s.attr("cq") || n.attr("srcid") != s.attr("srcid") || t.force && oldEnv && oldEnv.equals(Qt) || !Qt.p("cq") || !Qt.p("srcid") || 1 == Qt.p("_trf") ? (i.remove(), $(window).trigger("top_result_removed"), u(qt, e, "insertBefore")) : r = !0
            } else i.remove(),
            $(window).trigger("top_result_removed");
            else e.children().size() && u(qt, e, "insertBefore")
        } (),
        function() {
            var e = o.find("#top-ad"),
            t = $("#top-ad"),
        ...
        if (t.pdc.bindImgLoad(a), u(qt, a),
        function() {
            var e = o.find(".foot-async-script"),
            t = $(".foot-async-script"),
            i = t.children(),
            n = $("body");
            i.size() && t.remove(),
            e.children().size() && u(n, e)
        } (), !$("#footer").size()) {
        ...
        m(function() {
            ...
            o && $.globalEval(o.find("#jsMerge").html()),
            _(t, {
        ...
        _(t, {
            waittime: (new Date).getTime() - jt
        }),
        t.pdc.mark("dom"),
        $(window).trigger("swap_dom_ready", [t, e]),
        window.__lazy_foot_js ? setTimeout(function() {
            A(e, t, i)
        },
        0) : A(e, t, i),
        r ? window.scrollTo(n[0], n[1]) : window.scrollTo(0, 0),
    ...
    function A(e, t, i) {
        ...
        m(function() {
            var e = (new Date).getTime();
            t && t.base64 && (t.base64.setDomLoad("left"), t.base64.setDomLoad("right")),
            _(t, {
        ...
        m(function() {
            var e = (new Date).getTime();
            n && $.globalEval(n.find("#ecomScript").html()),
            _(t, {
        ...
        m(function() {
            var e = (new Date).getTime();
            bds.se.tools && (Ot && clearTimeout(Ot), Ot = setTimeout(function() {
                bds.se.tools()
            },
            600)),
            bds && bds.se && bds.se.certification && bds.se.certification.build && (Pt && clearTimeout(Pt), Pt = setTimeout(function() {
                $(".certification").size() > 0 && bds.se.certification.build.init()
            },
            1e3)),
            bds && bds.se && bds.se.safeTip && (Rt && clearTimeout(Rt), Rt = setTimeout(function() {
        ...
        m(function() {
            $(window).trigger("swap_end", [t, e]),
            B(),
            zt = (new Date).getTime(),
            t && t.pdc && (t.pdc.mark("js"), t.pdc.trigger("swap_end"))
        })
    }
    function E() {
        m(function() {
    ...
    function j() {
        Mt && Nt && (clearTimeout(Mt), Mt = setTimeout(Nt, at))
    }
    function R(e, t, i) {
        return function(t) {
            var n = $.extend({},
            t);
            if (e && !e.confirm) {
                bds.comm.cur_query = e.real_wd,
                !bds.comm.supportis && e && (i = e.pstg || 0),
                e.confirm = !0,
                Mt = !1,
                Nt = null;
                var o = {};
                ...
                e.env.equals(s) || e.env.clone({
                    wd: e.prw
                }).equals(s) || mt.setUrl(e.env),
                ut = lt.protocol + "//" + lt.host + lt.pathname + lt.search,
                e.seq ? e.seq++:e.seq = 1,
                e.pdc && (20 != i && bds.comm.supportis && e.pdc.mark("st"), e.pdc && e.pdc.setParam && e.pdc.setParam("cus_pstg", i), e.force && e.pdc.setParam("f4s", 1), e.pdc.trigger("confirm"), window.PRE_CONN.startTimer()),
                m(function() {
                ...
                if (bds.comm.indexSid && (/9998_/.test(bds.comm.indexSid) && "https:" === lt.protocol && (bds.comm.indexSid = bds.comm.indexSid.replace("9998", "8499")), a += "&rsv_isid=" + bds.comm.indexSid), e.no_predict && (a += "&isnop=" + (1 >= xt ? 0 : 1)), e && e.pstg && (a += "&isctg=" + e.pstg), xt = 0, h(nt,
                function(t) {
                    if (Ht && t.getRsvStatus) try {
                        a += "&rsv_stat=" + t.getRsvStatus(e.env.p("wd"))
                    } catch(i) {}
                    t.getStat("rsv_sug6") && (a += "&rsv_sug6=" + t.getStat("rsv_sug6"), bds.comm.seinfo && (bds.comm.seinfo.rsv_sug6 = t.getStat("rsv_sug6"))),
                    t.getStat("rsv_sug7") && (a += "&rsv_sug7=" + t.getStat("rsv_sug7")),
                    t.getStat("rsv_sug9") && (a += "&rsv_sug9=" + t.getStat("rsv_sug9")),
                    t.getStat("rsv_bp") && (a += "&rsv_bp=" + t.getStat("rsv_bp"))
                }), $.ajax({
                    headers: o,
                    url: a
                }).done(function(e) {
                    ...
                    bds.comm.seinfo.rsv_prw = encodeURIComponent(At.val()),
                    bds.comm.seinfo.rsv_pstg = i,
                    bds.comm.seinfo.rsv_svoice = window.__supportvoice ? "1": "0",
                    e.cftime += 1,
                    bds.comm.cftime = e.cftime + "";
                ...
                h(nt,
                function(e) {
                    20 == i ? e.updateInitData() : 22 == i || bds.comm.supportis || i >= 0 && 5 >= i && e.updateInitData(),
                    e.clearStat()
                }),
    ...
    function P(e) {
        ...
        if (ui) return ! 1;
        if (ui = !0, At.blur(), T(""), $(this).attr("target")) return ! 0;
        li = !0,
        ...
        try {
            ...
            if (!$.trim(At.val()) && !t) return lt.href = "/",
            !1;
            var i, n = new p,
            o = $(this).serializeArray();
            for (i = 0; i < o.length; i++) n.p(o[i].name, o[i].value);
            if (t && !$.trim(At.val()) ? (n.p("wd", t), n.p("rsv_dq", 1)) : $.trim(At.val()) && n.p("wd", At.val()), n.p("nojc") && n.p("nojc", ""), Jt) {
                if (n.equals(Jt.env.clone({
                    wd: Jt.real_wd
                })) && !Jt.force) return R(Jt, Kt, 22)(),
                Jt.force = !0,
                T(""),
                I(Jt),
                !1;
    ...
    function O(e) {
        ...
        if (n && n.p("wd") && n.hashCode() && (!pt && 1 != Cookie.get("ISSW") || o || !s) && (!ht && 1 != Cookie.get("ISSW") || o || s)) {
            if (c && (i = dt.hasCache(n, {
                ...
                frcache: 1
            }), L(n, i)), T(t.no_predict && 6 != t.pstg ? "": i.real_wd), I(i)));
            o && r && s && a(),
            i = {
                env: n,
                cftime: 0,
                ...
                log: {
                    ctime: (new Date).getTime() - zt,
                    wd: n.p("wd"),
                    ntime: 0,
                    stat: 0,
                    used: 0,
                    rtime: 0,
                    utime: o ? (new Date).getTime() - zt: 0,
                    res: 0
                }
            },
            i.pdc = f(i),
            t.pstg > 0 && (i.pstg = t.pstg),
            i.force && i.pdc.mark("st"),
            i.base64 = isbase64(i.pdc),
            Ut.push(i.log),
            yt++,
            xt++,
            U(i)
    ...
    function N(e) {
        t(),
        lt.replace(e.buildSyncSearchUrl())
    }
    function q(e, t) {
    ...
    function U(e) {
        var t, r, a = e.env,
        c = {};
        c.is_referer = Jt && Jt.env ? Jt.env.buildSyncSearchUrl() : Xt.replace(/\#.*$/, ""),
        ...
        if (! (1 == d && 1 == l || 11 == d && 3 == l || 11 == d && 6 == l || 1 == d && 4 == l)) {
            var u = "ie=utf-8" + (bds.comm.newindex ? "&newi=1": "") + (Ct.sid ? "&sid=" + encodeURIComponent(Ct.sid) : "") + (Ct.tnp ? "&tnp=" + encodeURIComponent(Ct.tnp) : "") + "&mod=" + (e.no_predict || !bds.comm.supportis ? "1": "11") + (bds.comm.supportis ? "&isbd=1": "") + "&isid=" + $t + "&" + a.buildQueryString() + "&rsv_sid=" + bds.comm.indexSid + "&_ss=1&clist=" + encodeURIComponent(dt.getCacheList()) + "&hsug=" + encodeURIComponent(M()) + (e.force ? "&f4s=1": "") + "&csor=" + getCursortPosition(At.get(0));
            ...
            if (! (e.no_predict && !e.force && (r = dt.find(function(e) {
                ...
                if (e.force && e.shouldShow) {
                    ...
                    if (r = dt.find(function(t) {
                        ...
                        return t.loaded || t.no_predict || !i || t === e || (t.shouldShow = !1),
                        !t.loaded && t.no_predict && t.force && i && t !== e && (t.shouldShow = t.shouldShow || e.shouldShow, t.startTime && f - t.startTime < 2e3 && (p = !0), window.__sam_backup_request || (p = !0)),
                        t.loaded || i ? void t.pdc.mark("st") : !0
                    }), p) return;
                    for (t = 0; t < r.length; t++) dt.deleteCache(r[t])
                }
                var h, b = function(t, i, n) {
                    if (0 == i) g(t, n),
                    e.pdc && (e.pdc.setParam("cus_srv", bds.se.mon.srvt), e.pdc.setParam("bsi", Cookie.get("__bsi")));
                    else if (1 == i) try {
                        var o = 1 * new Date;
                        e.b64ildata = $.parseJSON(t),
                        e.base64.ilparseTime = 1 * new Date - o,
                        e === Jt && (e.base64.inline(e.b64ildata), e.base64.ilrenderTime = 1 * new Date - o),
                        $(e).one("swap_begin",
                        function() {
                            this.base64.inline(this.b64ildata, this.html.get(0))
                        })
                    } catch(s) {} else 2 == i && e.base64 && (e.base64.ilsum = t)
                },
                g = function(t, s) {
                    if (s && "302" == s.status || t && $.trim(t).indexOf("<div>") > 10) return void(e.force ? (i(11), N(a)) : dt.deleteCache(e));
                    _(e, {
                    ...
                    if ( - 1 != d) {
                        r = $(t.substr(0, d)),
                        e.html = t.substr(d + c.length),
                        window.__dom_pre_parse && "1" == r.find("#__need_parse_dom").html() && (e.html = $(e.html));
                        try {
                            var l = $.parseJSON(r.find("#img_list").text());
                            e.base64.loadImg(l.right, l.left),
                            e.base64_loaded = !0
                        } catch(u) {}
                        try {
                    ...
                    e.real_wd = r.find("#__real_wd").eq(0).text(),
                    e.real_wd_org = r.find("#__real_wd_org").eq(0).text(),
                    e.real_wd_nosynx = r.find("#__real_wd_nosynx").eq(0).text(),
                    e.env && e.env.p("nojc") && e.real_wd_nosynx && (e.real_wd = e.real_wd_nosynx);
                    var b = !1; (a.p("wd") == o(At.val()) || e.force) && e.shouldShow && (b = !0),
                    e.real_wd && (e.prw = a.p("wd"), a.p("wd", e.real_wd));
                    var g = r.find("#__queryId").html(),
                    ...
                    if (e.chk = w ? w: 0, !t || !g && !p && !f && !m || !v && e.force) return e.force ? (a.p("__eis", 1), a.p("__eist", t ? t.length: 0), a.p("real_wd", e.real_wd), i(13), void N(a)) : void dt.deleteCache(e);
                    if (p > 0 && q(1e3 * p, !e.no_predict), -11 == m) {
                    ...
                    }), C = 0; C < k.length; C++) dt.deleteCache(k[C]);
                    return e.backup_request_timeout && clearTimeout(e.backup_request_timeout),
                    e.loaded = !0,
                    bds.comm.supportis || b ? void((b && e !== Jt || e.force) && (S(), e.shouldShow = !1, -11 == m ? e.pdc.init() : e.pdc.mark("net"), _(e, {
                        frcache: 0
                    }), L(a, e))) : !0
                };
                h = $.ajax({
                ...
                h.fail(function(t, n) {
                    e.force && e.shouldShow && "abort" != n && e.env && (i(12), lt.replace(e.env.buildSyncSearchUrl() + "&rsv_jmp=fail")),
                    dt.deleteCache(e)
                }),
                e.xhr = h,
                dt.addCache(e)
    ...
    function H(e) {
        window.index_off && window.index_off(),
        Lt.get(0) !== It.get(0) && (Lt.val(""), It.val(e.p("wd"))),
        At = It,
        pageState = 1,
        bds.comm.ishome = 0,
        h(nt,
    ...
    function G() {
        ...
        if (Math.pow(gi.x - hi.x, 2) + Math.pow(gi.y - hi.y, 2) >= Math.pow(_t, 2) || e * wt >= vt) {
            ...
            if (!bds.comm.supportis && i && $.trim(At.val()) && (!Jt || Jt.env.p("wd") != $.trim(At.val()))) {
                var n = (new p).clone({
                    wd: $.trim(At.val())
                });
                O({
    ...
    window.hash = function(e, t) {
        return e ? e && !t && Qt ? Qt.p(e) : void(e && t && Qt && (Qt.p(e, t), lt.href = Qt.buildSearchUrl())) : void 0
    };
    var V, Q, J, X, K, Y, Z = !1; !
    function() {
        var e = $.globalEval;
    ...
    function(e, t) {
        if (t) {
            var i = $("#isDebugInfo");
            i.size() || (i = $('<div id="isDebugInfo"></div>').appendTo("#debug")),
            i.html(t.html.find("#__isDebugInfo").html());
            var n = "<table>";
    ...
    var et = function() {
        var e;
        return function(t) {
            bds.comm.isDebug && alert(t),
            bds && bds.comm && bds.comm.js_error_monitor && (e = new Image, e.src = bds.comm.js_error_monitor + "?" + $.param({
                url: lt.href,
    ...
    if (window.setSugKey = function(e) {
        At && e && (Wt && Wt.setKey ? Wt.setKey(e) : At.val(e))
    },
    ...
    function() {
        ...
        $(".c-fanyi-abstract", e).val(0).html(i.html()),
        $(".c-fanyi-title", e).val(0).html(t.html()),
        t.html(o),
        i.html(n)
    ...
    dt = function() {
        ...
        return {
            ...
            hasCache: function(e, i) {
                ...
                i || (i = {});
                var o = n(e);
                return o && (new Date).getTime() - o.startTime > rt && (this.deleteCache(o), o = null),
                o
            },
    ...
    function() {
        ...
        function s(e) {
            ...
            t.hashCode() ? 0 == pageState && H(t) : 0 != pageState ? lt.replace(lt.pathname + lt.search.replace(/([?&])isidx=[^&*]&?/, "$1")) : lt.search != lt.search.replace(/([?&])isidx=[^&*]&?/, "$1") && lt.replace(lt.pathname + lt.search.replace(/([?&])isidx=[^&*]&?/, "$1")),
            mt.onurlchange(t, e)
        }
        var a = "onhashchange" in window,
        c = "onpopstate" in window;
        window.__disable_popstate && (c = !1);
        var l = lt.pathname.length > 1 ? lt.pathname: "/s"; (navigator.userAgent.match(/MSIE (6|7)/) || document.documentMode < 8) && (a = !1, c = !1),
        ot.disable_popstate && (c = !1),
        a || c || t();
        var u = function() {
            var t = "";
            return function(i, n) {
                n && (t = n.buildQueryString(), lt.hash = t),
                (i || t != e()) && (s(i), t = e())
            }
        } ();
        ...
        var m = function() {
            var e = i();
            return function(t, n) {
                n && (e = n.buildQueryString(), window.history.pushState(n, "", n.buildSyncSearchUrl())),
                t || e != i() ? (s(t), e = i()) : d()
            }
        } ();
    ...
    mt.onurlchange = function(e, t) {
        ...
        T("");
        var i = !0;
        t && Jt && Jt.env && Jt.env.equals(e) && (i = !1),
        O({
            env: e,
            force: !0,
            use_cache: i,
    ...
    var bt = ht,
    gt = bds.comm.switchAddMask ? bds.comm.switchAddMask: !1;
    gt || (gt = window.__switch_add_mask ? window.__switch_add_mask: !1),
    gt = !0;
    ...
    function() {
        ...
        lt.hash.match(/[^a-zA-Z0-9](wd|word)=/) ? (lt.replace("//www.baidu.com/s?" + lt.href.match(/#(.*)$/)[1]),
        function() {
    ...
    for (var Tt = Cookie.get("BAIDUID", "nobdid").split(":")[0], $t = Tt.substr(0, 6) + Tt.substr(Tt.length - 5, 5) + parseInt(99999 * Math.random()); $t.length < 16;) $t += "0";
    $t = encodeURIComponent($t);
    var St, Dt, It, Lt, At, Et;
    It = Lt = At = $(ot.kw);
    var jt, Rt, Pt, Ot, Mt, Nt, qt = $("#wrapper_wrapper"),
    Ut = [];
    window.__async_strategy,
    St = $(ot.index_form),
    "_blank" == St.attr("target") && (window.__disable_index_predict = !0, ft = pt = !0);
    var Bt = St.serializeArray();
    Dt = $(ot.result_form);
    var zt = (new Date).getTime();
    window.pageState = 0;
    var Ht, Ft, Wt, Gt, Vt, Qt = null,
    Jt = null,
    ...
    if ("1" === nt) {
        ...
        var e = $.Deferred();
        return require(["@baidu/search-sug"],
        function(t) {
            Ht = Ft = Wt = t({
                bds: bds,
                maxNum: 10,
    ...
    "https:" == lt.protocol && bds.comm.ishome && !/Chrome/.test(navigator.userAgent) && $(document).delegate("a", "mousedown",
    function() {
        var e = $(this),
        t = e.attr("href"),
        i = {
    ...
    function() {
        ...
        if (.01 > o && !/www\.baidu\.com\//.test(t) && /^http/.test(t)) {
            var s = n + "&c_url=" + encodeURIComponent(t),
            i = new Image,
    ...
    mt.support() && $(document).delegate("a", "click",
    function() {
            ...
            if (! (t.attr("target") && "_self" != t.attr("target") || t.attr("sync") && "true" == t.attr("sync"))) {
                ...
                if (i && 0 == i.indexOf(e) && (i = i.substring(e.length)), i && (matched = i.match(/^\/*s\?(.*)/)), i && matched) {
                    ...
                    if (n.pn || (n.pn = ""), l(["baidurt", "baiduwb", "baidufir", "SE_baiduxueshu_c1gjeupa"], n.tn) < 0) {
                        ...
                        var s = mt.clickResultLink(t, Qt, n)
                    }
                    return s
                }
            }
    ...
    function(e) {
        ...
        e.fn.textWidth = function() {
            t || (t = e('<div data-for="result" style="clear:both;display:block;visibility:hidden;position:absolute;top:0;"><span style="width;inherit;margin:0;font:16px/22px arial;"></span></div>').appendTo("body").find("span")),
            t.html(escapeHTML(e(this).val()));
            var i = t.width();
            return i
        }
    } (jQuery);
    ...
    function(e, t) {
        var i = ""; ! t || !t.real_wd || t.no_predict && 6 != t.pstg || (i = t.real_wd),
        T(i),
        I(t)
    }),
    $(window).on("swap_end",
    function(e, t) {
        t && (window.cfpromise = new $.Deferred, Mt && (clearTimeout(Mt), Mt = !1, Nt = null), t.confirm = !1, t.force ? R(t, Kt, 20)() : (Nt = R(t, Kt, 21), Mt = setTimeout(Nt, at)))
    }),
    $(window).on("indexOff",
    function(e, t) {
        h(nt,
    ...
    mt.support() && "_blank" != St.attr("target") && h(nt,
    function(e) {
        e.setMaxNum(ct)
    });
    var di, li = !1,
    ...
    $(window).on("swap_end",
    function(e, t) {
        t || (bds.comm.confirmQuery = bds.comm.query, bds.comm.confirmQid = bds.comm.qid, y()),
    ...
    $(function() {
        ...
        t = $("head");
        kt = function() {
            e.nextAll().not("[data-for]").not("#passport-login-pop").remove(),
            t.find("*").not("[data-for]").not("meta").not("title").not("script[async]").not('link[href*="passport"]').not('link[rel*="icon"]').not('link[rel*="shortcut icon"]').remove()
        }
    }),
    bds.comm.resultPage && z(),
    qt.delegate("#page strong+a,#page a.n", "mouseover",
    function() {
        O({
    ...
    $("#u .back_org").click(function() {
        var e = new Date;
        e.setTime((new Date).getTime() + 110376e7),
        Cookie.set("ORIGIN", 2, document.domain, "/", e),
        Qt ? lt.replace(Qt.buildSyncSearchUrl({
            _r: Math.random()
        })) : lt.href = "/"
    }),
    $(window).scroll(function() {
        ...
        r = 50,
        a = function() {
            bds.comm.isPeakStyle && 50 === r && (r = 0),
            e && (clearTimeout(e), e = !1),
            e = setTimeout(function() {
                var r = i.scrollTop();
                r > 10 && s > r && bds.comm.isPeakStyle && (t.addClass("peak-middle"), t.removeClass("peak-down")),
                r > n + o ? e = setTimeout(function() {
                    t.addClass("s_down"),
                    r > s && bds.comm.isPeakStyle && (t.addClass("peak-down"), t.removeClass("peak-middle")),
                    h(nt,
                    function() {
                        Wt.hide()
                    })
                ...
                0) : n + o >= r && (e = setTimeout(function() {
                    ...
                    t.removeClass("peak-middle"),
                    o > 20 && bds.comm.isPeakStyle && t.addClass(r > s ? "peak-down": "peak-middle")
                },
                0)),
                20 >= r && bds.comm.isPeakStyle && (t.removeClass("peak-down"), t.removeClass("peak-middle"))
            },
            r)
        };
        return a(),
...
function user_c(e) {
    ...
    return o = "&mu=" + s,
    r.src = a + "/v.gif?pid=201&pj=psuser&" + t + "path=" + s + "&wd=" + i + "&t=" + (new Date).getTime(),
    !0
}
function initPassV3() {
...
function isbase64(e) {
    ...
    function n(e) {
        for (var t = e,
        i = 0; __callback_names.hasOwnProperty(e) || window[e];) e = t + "_" + i,
        i++;
        return __callback_names[e] = 1,
        e
    }
    function o(e) {
        if ("string" == typeof e) {
    ...
    function r() {
        var e = v.concat(p.left, p.right),
        t = g = $.when.apply($, e);
        g.always(function() { + new Date,
            t === g && (2 == c.b64Exp && _("left"), _("right"))
        })
    }
    function a(e, t) {
        try {
    ...
    e.onSendlog(function() {
        ...
        e.setParam("cus_cusval", t.join("|")),
        E.isinline() && (e.setParam("cus_b64il", E.ilsum), E.ilparseTime && e.setParam("cus_b64ilpt", E.ilparseTime), E.ilrenderTime && e.setParam("cus_b64ilrt", E.ilrenderTime))
    });
    var w = function(e, t, i, n) {
        if (n = n ? $(n).find("#" + d[t])[0] : document.getElementById(d[t])) for (var o = n.getElementsByTagName("IMG"), s = 0; s < o.length; s++) {
            ...
            r && (e.hasOwnProperty(r) && e[r] ? a(o[s], e[r]) : T(o[s]))
        }
    },
    _ = function(e) {
        w(f[e], e, "data-b64-id")
    ...
    x = !1,
    k = function(e, t) {
        y || w(e, "right", "data-b64il-id", t),
        t && (y = !0),
        x = !0
    },
    C = 0,
    T = function(t) { (t.getAttribute("data-b64-id") || t.getAttribute("data-b64il-id")) && null != t.getAttribute("data-src") && (t.src = t.getAttribute("data-src"), e.setParam("cus_b64fails", ++C))
    },
    S = function(e) {
        I(e, "right")
    },
...
function formatDate(e, t) {
    ...
    return ("number" == typeof e || "string" == typeof e) && (e = new Date(e)),
    [e.getFullYear(), i(e.getMonth() + 1), i(e.getDate())].join(t || "")
}
function baseChangeUrl(e) {
    bds.comm.search_tool.st && bds.comm.search_tool.et && bds.comm.search_tool.stftype && e.indexOf("&gpc=") < 0 && (e += "&gpc=" + encodeURIComponent("stf=" + bds.comm.search_tool.st + "," + bds.comm.search_tool.et + "|stftype=" + bds.comm.search_tool.stftype)),
    bds.comm.search_tool.si && e.indexOf("&si=") < 0 && (e += "&si=" + encodeURIComponent(bds.comm.search_tool.si) + "&ct=2097152"),
    bds.comm.search_tool.sl_lang && e.indexOf("&sl_lang=") < 0 && (e += "&rsv_srlang=" + encodeURIComponent(bds.comm.search_tool.sl_lang), e += "&sl_lang=" + encodeURIComponent(bds.comm.search_tool.sl_lang), e += "&rsv_rq=" + encodeURIComponent(bds.comm.search_tool.sl_lang)),
    changeUrl(e)
}
...
function() {
    function getUA() {
        ...
        return t.mac = navigator.platform.toUpperCase().indexOf("MAC") >= 0,
        (e = i.match(/rv:([\d.]+)\) like gecko/)) ? t.ie = e[1] : (e = i.match(/(msie\s|trident.*rv:)([\w.]+)/)) ? t.ie = e[2] : (e = i.match(/firefox\/([\d.]+)/)) ? t.firefox = e[1] : (e = i.match(/chrome\/([\d.]+)/)) ? t.chrome = e[1] : (e = i.match(/opera.([\d.]+)/)) ? t.opera = e[1] : (e = i.match(/version\/([\d.]+).*safari/)) ? t.safari = e[1] : 0,
        t
    }
    ...
    function checkInputValue() {
        var e = $input.val();
        setTimeout(function() {
            var t = $input.val(); (t !== e || t.length > 0) && $(".kw-placeholder").toggleClass("placeholders-hidden", t.length > 0)
        },
        0)
    }
    ...
    function getShowCount(e, t) {
        var i = 0;
        return t && t.query && t.query === e && t.count && (i = t.count),
        i
    }
    function recordDefaultQuery(e, t) {
        ...
        t && t.query && e === t.query && t.count && (i.count = t.count + 1),
        setTimeout(function() {
            try {
                localStorage.removeItem("index_ls_default_query"),
                localStorage.setItem("index_ls_default_query", JSON.stringify(i))
            } catch(e) {
                return ! 1
            }
        },
    ...
    if (getShowCount(defaultQuery, defaultQueryHis) > 9 && (defaultQuery = ""), defaultQuery) {
        ...
        createPlaceHolder($input, isPlaceHolderSupported, defaultQuery, UA),
        isSupportLocalStorage && recordDefaultQuery(defaultQuery, defaultQueryHis),
        $(window).one("index_off",
        function() {
            removePlaceHolder($input, isPlaceHolderSupported),
            bds.comm.dpquery = ""
        })
    }
} ();
...
bds.amd.addPaths({
    ...
    "soutu/js/tu": "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/soutu/js/tu_3002cad",
    ...
    "plugins/bzPopper": "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/plugins/bzPopper_8698bfd",
...
bds.amd.addPaths({
    ...
    "@baidu/search-sug": "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/amd_modules/@baidu/search-sug_76340ce",
    ...
    "@searchfe/inject-js": "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/amd_modules/@searchfe/inject-js_7682edb",
...
bds.amd.addPaths({
    ...
    "@baidu/search-sug/sug/index": "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/amd_modules/@baidu/search-sug/sug/index_886f41b",
...
bds && bds.comm && (bds.comm.did = function() {
    for (var e = "",
    t = 0; 32 > t; t++) e += Math.floor(16 * Math.random()).toString(16);
    return e
...
jQuery && jQuery.extend({
    ...
    format: function(e, t) {
        ...
        return i.length ? (i = 1 == i.length && null !== t && /\[object Array\]|\[object Object\]/.test(n.call(t)) ? t: i, e.replace(/#\{(.+?)\}/g,
        function(e, t) {
            var o = i[t];
            return "[object Function]" == n.call(o) && (o = o(t)),
    ...
    subByte: function(e, t, i) {
        ...
        i = i || "…";
        for (var s = 0,
        r = o.length; r > s; s++) o[s].charCodeAt(0) > 255 && n.push("*"),
        n.push(o[s]);
        return t && t > 0 && n.length > t ? o = n.join("").substring(0, t - 1).replace(/\*/g, "") + i: e
    },
    getByteLength: function(e) {
        for (var t = [], i = e.split(""), n = 0, o = i.length; o > n; n++) i[n].charCodeAt(0) > 255 && t.push("*"),
        t.push(i[n]);
        return t.length
    },
...
function() {
    ...
    s = function(e, t, i) {
        ...
        else if ("object" == typeof t) for (var o in t) t.hasOwnProperty(o) && (n.data[o] = t[o]);
        else n.data[t] = i
    };
...
function() {
    ...
    d = function() {
        for (var e, t, i = $(".result-op").get().concat($(".result").get()), n = {},
        o = 0; t = i[o]; o++)(e = t.getAttribute("tpl")) && (n[e] ? n[e].push(t) : n[e] = [t]);
        return n
    },
    l = [],
    u = [];
    ...
    $.extend(e._Aladdin.prototype, {
        _init: function() {
            ...
            e.p1 = i.p1 || t.id,
            e.mu = i.mu || t.getAttribute("mu"),
            e.srcid = i.rsv_srcid || t.getAttribute("srcid")
        },
        q: function(e, t) {
            return t = t || "",
            $(this.container).find(t + "." + e).get()
        },
        qq: function(e, t) {
            return this.q(e, t)[0]
        },
    ...
    t.push(function(e) {
        ...
        if (t) {
            ...
            $.each(e.container.getElementsByTagName("form"),
            function(e, t) {
                var n = function() {
    ...
    e.__runAla = function() {
        ...
        function(t, n) {
            ...
            o && $.each(o,
            function(t, i) {
                e._currentContainer = i,
                n.fn(),
                e._currentContainer = null
            })
        }),
        $.each(e.groupData,
        function(i, n) {
            var s, r, a, c = new e._Aladdin;
            c.container = n.container,
            c.data = n.data,
            c._init(),
            e.list.push(c);
            var d = n.handlers;
...
function() {
    function e(s, r) {
        ...
        if (a.length > 1) if (r) e(a.shift(),
        function() {
            a.length > 0 && e(a, r)
        });
        else for (; a.length;) e(a.shift());
        else {
            if (s = a[0], "jquery" === s && window.jQuery) return ! o.ui.jquery && (o.ui.jquery = window.jQuery),
            void(r && r());
            var c = s.replace(/\./g, "/"),
            d = s.replace(/^[\s\S]*\./, ""),
            l = o.uiPrefix + c + "/" + d;
    ...
    function() {
        ...
        t = function(e, t, i) {
            $(e).each(function(e, n) {
                ...
                s.onload = function() {
                    ...
                    a = this.height,
                    c = r / a / (e / n);
                    c > 1 ? (r = r > e ? e: "auto", a = "auto") : (a = a > n ? n: "auto", r = "auto"),
                    o.css({
                        height: a,
                        width: r
                    }),
        ...
        e && t("img.result-left-img", 98, 121),
...
define("modules/window/token", ["require", "exports"],
function(e, t) {
    "use strict";
    t.__esModule = !0,
    t.PERF_SYNC_DATA = t.NAVIGATOR = t.PERFORMANCE = t.LOCAL_STORAGE = t.DOCUMENT = void 0;
    var i = "document";
    t.DOCUMENT = i;
    var n = "localStorage";
    t.LOCAL_STORAGE = n;
...
define("modules/comm/comm.service", ["require", "exports"],
function(e, t) {
    "use strict";
    t.__esModule = !0,
    t.Comm = void 0;
    var i = function() {
        ...
        return e.prototype.getValue = function(e) {
            return e ? this.data[e] : ""
        },
        e
    } ();
    t.Comm = i
}),
define("modules/log/log.service", ["require", "exports"],
function(e, t) {
    "use strict";
    t.__esModule = !0,
    t.Log = void 0;
...
define("modules/san-option/san-option.service", ["require", "exports"],
function(e, t) {
    "use strict";
    t.__esModule = !0,
    t.SanOption = void 0;
...
define("modules/san-option/san-option.provider", ["require", "exports"],
function(e, t) {
    "use strict";
    t.__esModule = !0,
    t.SanOptionProvider = void 0;
    var i = function() {
        function e() {}
...
define("modules/async-cache/async-cache-item.service", ["require", "exports"],
function(e, t) {
    "use strict";
    t.__esModule = !0,
    t.AsyncCacheItem = void 0;
    var i = function() {
        function e() {}
        return e
    } ();
...
define("modules/webb/config.service", ["require", "exports"],
function(e, t) {
    "use strict";
    t.__esModule = !0,
    t.WebbConfig = void 0;
...
define("modules/webb/config.value", ["require", "exports"],
function(e, t) {
    "use strict";
    t.__esModule = !0,
    t.webbConfigValue = void 0,
    t.webbConfigValue = {
        config: {
            "1_3": {
                et_js: {
...
define("modules/webb/instance.service", ["require", "exports", "tslib", "@searchfe/inject-js", "@baidu/webb", "../window/token", "./config.service"],
function(e, t, i, n, o, s, r) {
    "use strict";
    t.__esModule = !0,
    t.WebbInstance = void 0,
    ...
    var a = function() {
        ...
        e.prototype.getInstance = function(e) {
            ...
            return this.instances[e] = new o["default"](t),
            this.instances[e]
        };
        var t, a;
...
define("@baidu/www-api", ["require", "exports", "modules/log/log.service", "modules/comm/comm.service", "modules/san-option/san-option.service", "modules/san-option/san-option.provider", "modules/window/token"],
function(e, t, i, n, o, s, r) {
    "use strict";
    t.__esModule = !0,
    t.NAVIGATOR = t.PERFORMANCE = t.LOCAL_STORAGE = t.DOCUMENT = t.SanOptionProvider = t.SanOption = t.Comm = t.Log = void 0,
    t.Log = i.Log,
    t.Comm = n.Comm,
    t.SanOption = o.SanOption,
    t.SanOptionProvider = s.SanOptionProvider,
    t.DOCUMENT = r.DOCUMENT,
    t.LOCAL_STORAGE = r.LOCAL_STORAGE,
    t.NAVIGATOR = r.NAVIGATOR,
    t.PERFORMANCE = r.PERFORMANCE
}),
define("modules/perf-log/perf-log.service", ["require", "exports", "tslib", "../window/token", "../comm/comm.service", "@searchfe/inject-js", "../async-cache/async-cache-item.service", "../webb/instance.service"],
function(e, t, i, n, o, s, r, a) {
    "use strict";
    t.__esModule = !0,
    t.PerfLog = void 0;
    var c = function() {
        function e(e, t, i, n, o) {
            ...
            s || (this.wwwWebb = i.getInstance("1_87"), this.comm = e, this.sendFsLog(t, n), this.sendAsyncLog(t))
        }
        e.prototype.sendFsLog = function(e, t) {
            var i;
            if (e && e.log ? i = e.log.waittime: t && (i = t.resultEnd), i) {
                var n = this.comm.getValue("qid");
            ...
            if (e && e.now && e.timing) {
                ...
                if (i) {
                    ...
                    if (i.req = o.responseStart - o.requestStart, i.resp = o.responseEnd - o.responseStart, i.tcp = o.connectEnd - o.connectStart, i.domLoading = o.domLoading - o.navigationStart, i.domReady = o.domContentLoadedEventStart - o.navigationStart, i.domTime = o.domContentLoadedEventStart - o.domLoading, e.memory) {
                        var s = e.memory;
                        i.usedJSHeapSize = s.usedJSHeapSize / 1e3,
                        i.usedJSHeapRate = s.usedJSHeapSize / s.totalJSHeapSize * 100
                    }
                    if (e.getEntriesByType) {
                        var r = e.getEntriesByType("navigation");
                        r && r[0] && (i.pageSizeGzip = r[0].encodedBodySize / 1e3, i.pageSize = r[0].decodedBodySize / 1e3)
                    }
...
function(e, t, i, n, o, s) {
    ...
    var r = function() {
        ...
        e.prototype.send = function(e, t) {
            if (e && t) {
                var i = this.comm.getValue("qid");
                this.wwwWebb.updateOption({
                    lid: i
                }),
                t = JSON.parse(t),
                this.wwwWebb.sendPfLog(t, {
                    env: "pc",
                    card: e
                },
                {
        ...
        var t, r;
        return e = i.__decorate([o.injectable, i.__metadata("design:paramtypes", ["function" == typeof(t = "undefined" != typeof n.Comm && n.Comm) ? t: Object, "function" == typeof(r = "undefined" != typeof s.WebbInstance && s.WebbInstance) ? r: Object])], e)
    } ();
    t.PerfCardLog = r
}),
define("modules/molecule/molecule.service", ["require", "exports", "tslib", "@searchfe/inject-js", "../san-option/san-option.provider", "../san-option/san-option.service"],
function(e, t, i, n, o, s) {
    "use strict";
    t.__esModule = !0,
    t.MoleculeService = void 0;
    var r = function() {
        function t(e) {
            this.moleList = [],
            e.addProvider(s.SanOption, o.SanOptionProvider);
            var t = Array.prototype.slice.call($(".result-op[m-name]"));
            this.execute(t, e)
        }
        t.prototype.execute = function(t, i) {
            var n = this;
            t.forEach(function(t) {
                ...
                function(e) {
                    if (e["default"]) {
                        o.SanOptionProvider.setElement(a);
                        var t = e["default"],
                        s = i.createMolecule(t);
                        n.moleList.push(s)
                    }
                })
            })
...
function(A) {
    ...
    function bindP5() {
        ...
        bindP5ClickData = function(e) {
            for (var t = 0,
            i = e.length; i > t; t++) if (item = e[t], isResult(item)) setClickData(item, {
                p5: index++
            });
    ...
    function getXPath(e, t, i) {
        ...
        if (e.parentNode !== t && (i = getXPath(e.parentNode, t, i)), e.previousSibling) {
            var n = 1,
            o = e.previousSibling;
            do 1 == o.nodeType && o.nodeName == e.nodeName && n++,
            o = o.previousSibling;
            while (o)
        }
        return 1 == e.nodeType && i.push(e.nodeName.toLowerCase() + (n > 1 ? n: "")),
        i
    }
    function bindLogEvent() {
        ...
        function(e) {
            ...
            try {
                ...
                if (!s.length) return;
                s.hasClass("result-op") ? n = "alop": s.hasClass("result") && (n = "as"),
                o = s.get(0);
                var r = getXPath(t, o);
    ...
    function getType(e, t, i) {
        fixPcTypeNode(t, i);
        for (var n = t,
        o = Object.getOwnPropertyNames(LOG_CLASS).map(function(e) {
            return LOG_CLASS[e]
    ...
    function fixPcTypeNode(e, t) {
        for (var i = null,
        n = "",
        o = ""; e !== t && null === i;) n = $(e).attr("class") || "",
        n.replace(new RegExp(".*(" + wiseClassPrefix + "\\w+).*"),
        function(e, t) {
            o = t
        }),
        o && (i = e),
    ...
    function log(e, t, i, n) {
        if (null == t.getAttribute("data-nolog")) {
            ...
            if ("input" == o) if (/input|textarea/.test(f)) p = t.value,
            t.type && "password" == t.type.toLowerCase() && (p = "");
            ...
            do {
                ...
                if (v = u.getAttribute("data-click")) try {
                    ...
                    v.hasOwnProperty(w) && ("undefined" == typeof b[w] || g[w]) && (b[w] = v[w])
                } catch(y) {
                    clickDebug(y)
                }
                u = u.parentNode
            ...
            if ("title" == o ? "mu" in b && delete b.mu: b.mu || (b.mu = r), _)"fm" in b && delete b.fm;
            else if ("input" == o && (b.fm = "beha", b.url = s), b.fm || (b.fm = n), !b.fm) return;
            window.c(b)
        }
    }
    ...
    window.initResultClickLog = function() {
        if (contentLeft = $("#content_left").get(0), contentRight = $("#con-ar").get(0), contentTop = $("#con-at").get(0), A.has) {
            ...
            $.each(t,
            function(t, i) { (e = i.getAttribute("srcid")) && A.ids.push([i.id, e])
            })
        }
        bindP5()
    },
...
$(document).ready(function() {
    ...
    function(t) {
        ...
        s = n.length ? n.find(".wnor-fanli-wrap") : []; ! t.ctrlKey && (o.length && "none" === o.css("display") || s.length && "none" === s.css("display")) && (e = setTimeout(function() {
            i.find(".c-recommend").hide(),
            o.show(),
            i.find(".wnor-fanli-wrap").hide(),
            s.show()
        },
        150))
    }),
...
bds.util.setContainerWidth = function() {
    ...
    o = 1217;
    if (o > i) e.removeClass("container_l container_xl").addClass("container_s"),
    t.removeClass("wrapper_l").addClass("wrapper_s"),
    bds.comm.containerSize = "s";
    else {
        if (! (i >= o)) return;
        e.removeClass("container_s container_xl").addClass("container_l"),
        t.removeClass("wrapper_s").addClass("wrapper_l"),
...
$.extend(bds.util.setFootStyle.prototype, {
    ...
    bindEvent: function() {
        var e = this;
        e.ie6 && $(window).on("resize.setFootStyle, scroll.setFootStyle",
        function() {
            e.setFixedIe6()
        })
    }
...
bds.se.tip = function(e) {
    ...
    this.init = function() {
        ...
        e.arrow && (this.op.arrow.has = 0 == e.arrow.has ? 0 : 1, this.op.arrow.offset = e.arrow.offset >= 0 ? e.arrow.offset: 10, this.op.arrow.r = e.arrow.r, this.op.arrow.c = e.arrow.c, e.arrow.excursion && (this.op.arrow.excursion = e.arrow.excursion)),
        e.offset && (this.op.offset.x = e.offset.x || 0 == e.offset.x ? e.offset.x: 10, this.op.offset.y = e.offset.y || 0 == e.offset.y ? e.offset.y: 20),
        this.ext = e.ext || {},
        this.dom = $("<div>", {
    ...
    this.bindEvent = function() {
        ...
        "over" == this.op.mode) {
            var e = this;
            $(e.op.target).on("mouseenter",
            function() {
                window.clearTimeout(e.delay.outIcon),
                window.clearTimeout(e.delay.outDom),
                e.delay.overIcon = setTimeout(function() {
                    e.show()
                },
                200)
            }),
            ...
            function() {
                window.clearTimeout(e.delay.outIcon),
                window.clearTimeout(e.delay.outDom),
                e.delay.overDom = setTimeout(function() {
                    e.show()
                },
                200)
            }),
            $(e.op.target).on("mouseleave",
            function() {
                window.clearTimeout(e.delay.overIcon),
                window.clearTimeout(e.delay.overDom),
                e.delay.outIcon = setTimeout(function() {
                    e.hide()
                },
                200)
            }),
    ...
    this.enableCloseIcon = function() {
        ...
        var n = $("<div>", {
            "class": "c-tip-close"
        }).html(i).appendTo(this.dom).click(function() {
            e.hide()
        });
        this.close = n
    },
    ...
    this.autoOffset = function() {
        ...
        l = {};
        c.h + a - s.h - o.top > i.h ? (d.top = s.h + o.top + this.op.arrowSize / 2, this.arrow && this.arrow.removeClass("c-tip-arrow-down")) : o.top - a > i.h ? (d.top = o.top - i.h - this.op.arrowSize / 2, this.arrow && this.arrow.addClass("c-tip-arrow-down")) : (d.top = s.h + o.top + this.op.arrowSize / 2, this.arrow && this.arrow.removeClass("c-tip-arrow-down")),
        e = o.left + s.w / 2 - this.op.arrow.offset - this.op.arrowSize / 2,
        d.left = e,
        d.left > 0 && d.left + i.w > c.w ? (d.left = o.left + s.w / 2 - i.w + this.op.arrow.offset + this.op.arrowSize / 2, l.right = this.op.arrow.offset + this.op.arrowSize, l.left = "auto", d.left < 0 && (d.left = e, l.left = this.op.arrow.offset, l.right = "auto")) : (l.left = this.op.arrow.offset, l.right = "auto"),
        this.dom.css(d);
        var u = t && this.op.arrow.excursion && this.op.arrow.excursion.x ? this.op.arrow.excursion.x: 0;
        l.left = this.op.arrow.offset + u,
        this.arrow && this.arrow.css(l)
    },
...
$(document).mousedown(function(e) {
    e = e || window.event;
    for (var t = e.target || e.srcElement; t && t.tagName && t != document.body && "html" != t.tagName.toLowerCase() && (!t.className || -1 === t.className.indexOf("c-tip-con"));) t = t.parentNode;
    t && t.className && -1 === t.className.indexOf("c-tip-con") && $(bds.comm.tips).each(function() {
...
bds.se.login = function() {
    ...
    o = function(n) {
        t ? (bds.se.passv3.setSubpro(e), bds.se.passv3.setMakeText(i), bds.se.loginCallbackFunc = n ||
        function() {
        ...
        function() {
            initPassV3(),
            t = !0,
            bds.se.passv3.setSubpro(e),
            bds.se.passv3.setMakeText(i),
            bds.se.loginCallbackFunc = n ||
            function() {
                window.document.location.reload(!0)
            },
            bds.se.passv3.show()
    ...
    s = function(e) {
        if (bds.comm) {
            ...
            window.bdUser = e,
            bds.se.passv3.hide(),
            bds.se.loginCallbackFunc.call(window, 1, e);
...
bds.se.tool = function(item) {
    ...
    this.render = function() {
        ...
        baoFlag = $(item).parent().find(".c-trust-as.baozhang-new"),
        isOffical = 0,
        vLevel = 0;
        officalLogo && "官方" == officalLogo.html() && (isOffical = 1),
        vLogo && vLogo.attr("hint-data") && (vLevel = $.parseJSON(vLogo.attr("hint-data")).hint[0].vlevel),
        baoFlag.length > 0 && (vLevel = 8);
...
bds.se.tool.share = function(e, t) {
    ...
    this.init = function(e, t) {
        ...
        function() {
            ...
            s = $(".c-tools-share", o.dom.get(0))[0],
            r = i ? bds.se.share: __bdshare;
            r.render({
                boxEle: s,
                url: e.url,
                txt: e.title + " -- 分享自百度搜索"
...
bds.se.tool.favo = function(e, t) {
    ...
    this.init = function(e, t) {
        if (e) {
            ...
            i.src = n + "?url=" + encodeURIComponent(e.url) + "&jump=" + encodeURIComponent(o + "/myfavorite/set?irt=1&t=" + encodeURIComponent(e.title) + "&id=" + encodeURIComponent(t) + "&c=bds.se.tool.favo.succ") + "&key=url",
...
bds.se.tool.favo.succ = function(json) {
    ...
    if (json.suc) {
        ...
        case 2:
            succContent += '<li class="c-tip-item-succ"><span class="favo-icon success-icon c-gap-right-xsmall"></span>个人中心“<a href="http://i.baidu.com/my/collect" target="_blank">我的收藏</a>”</li>',
            succContent += '<li class="c-tip-item-succ"><span class="favo-icon success-icon c-gap-right-xsmall"></span>百度首页“<a href="http://www.baidu.com" target="_blank">我的导航</a>”</li>';
            break;
        case 3:
            succContent += '<li class="c-tip-item-succ"><span class="favo-icon success-icon c-gap-right-xsmall"></span>个人中心“<a href="http://i.baidu.com/my/collect" target="_blank">我的收藏</a>”</li>',
            succContent += '<li class="c-tip-item-fail"><span class="favo-icon fail-icon c-gap-right-xsmall"></span>百度首页“<a href="http://www.baidu.com" target="_blank">我的导航</a>”</li>';
            break;
        case 4:
            succContent += '<li class="c-tip-item-fail"><span class="favo-icon fail-icon c-gap-right-xsmall"></span>个人中心“<a href="http://i.baidu.com/my/collect" target="_blank">我的收藏</a>”</li>',
            succContent += '<li class="c-tip-item-succ"><span class="favo-icon success-icon c-gap-right-xsmall"></span>百度首页“<a href="http://www.baidu.com" target="_blank">我的导航</a>”</li>'
...
bds.se.slide = function(e) {
    ...
    this.createDom = function() {
        ...
        o = h,
        s = b,
        e = $.format(e, r.op.src, l, p, r.op.width, r.op.height, r.op.width / 2),
        "static" === r.op.target.css("position") && r.op.target.css({
            position: "relative",
            width: "100%"
        }),
        r.op.target.append(e),
        t = n = r.op.target.find("div").eq(0),
        r.op.play && (i = $('<img src="' + r.op.play.src + '" style="width:' + r.op.play.width + "px; height:" + r.op.play.height + "px; position:absolute; top:50%; left:50%; margin-left: -" + r.op.play.width / 2 + "px; margin-top: -" + r.op.play.height / 2 + "px; \" onmousedown=\"return c({'tab':'logo_button_click'})\" />").insertAfter(t), n = i),
        r.op.isPad && t.css("background-size", r.op.width * r.op.frames / 2 + "px " + r.op.height + "px"),
        window.devicePixelRatio && window.devicePixelRatio > 1 && r.op.isRetina && t.css("background-size", r.op.width * r.op.frames + "px " + r.op.height + "px"),
        m.length ? (t.wrap('<a href="' + m.attr("href") + '" target="' + m.attr("target") + '"></a>'), m.attr("title") && t.attr("title", m.attr("title"))) : t.on("mousedown",
        function() {
            c({
    ...
    this.initAnimate = function() {
        ...
        if (! (l >= d.length)) {
            ...
            m = i.trigger_frame,
            p = $("#lg area");
            p.length && p.attr("onmousedown") && t.on("mousedown",
            function() {
                return new Function(p.attr("onmousedown"))()
            }),
            u = new Image,
            u.src = r.op.src,
            t.bind("first_animate",
            function() {
                u.complete ? e() : u.onload = e
            }),
            o ? t.trigger("first_animate") : s && (r.enablePointer(), n.show().on(s,
            function() {
    ...
    this.animation = function() {
        ...
        if (e = b ? d[l] : l + 1 >= d.length ? d[l] : d[l + 1]) {
            ...
            y = e.trigger_frame;
            v && (f && n.off(f), l < d.length - 1 || b ? (r.enablePointer(), n.on(v,
            function() {
                b || l++,
                p && p.call(r),
                w && w.call(r),
        ...
        function() {
            ...
            r.timer.push(setTimeout(function() {
                t.css("background-position", -(o * h) + "px 0"),
                h++,
                h >= c ? (r.dispose(), g++, 0 !== m && g >= m ? (h = null, g = null, p && p.call(r), l++, l < d.length && r.play(), b && l--) : (h = a - 1 > 0 ? a - 1 : 0, r.timer.push(setTimeout(arguments.callee, s)))) : r.timer.push(setTimeout(arguments.callee, s))
            },
            u))
        } ()
    },
    this.dispose = function(e) {
        e = e || r.timer;
        for (var t = 0,
        i = e.length; i > t; t++) window.clearTimeout(e[t]);
        e.length = 0
    },
...
var bds = bds || {};
bds.se = bds.se || {},
bds.se.banner = function(e, t, i) {
    this.init = function() {
        i = i || {},
        this.$dom_panel = $(e),
        this.hintText = t,
        this.hintIcon = i.iconClass || "",
        this.downUrl = i.downUrl || "",
        this.hintCookie = i.cookie || "",
        this.showNum = this.hintCookie && $.getCookie(this.hintCookie) ? Number($.getCookie(this.hintCookie)) : 0,
        this.nscTab = i.nscTab || "",
        this.ishome = bds.comm && 1 == bds.comm.ishome ? 1 : 0,
        this.bannerType = i.bannerType || "",
        e && t && this.showNum < 5 && !$(".baiduapp_banner")[0] && !$(".res_top_banner")[0] && !$(".res_top_banner_for_win")[0] && this.show()
    },
    this.show = function() {
        this.render(),
        this.showNum += 1,
    ...
    this.render = function() {
        var e = [];
        e = e.concat("WIN" !== this.bannerType ? ['<div class="res_top_banner">', '<i class="c-icon ' + (this.hintIcon ? this.hintIcon: "res_top_banner_icon") + '"></i>', "<span>" + this.hintText + "</span>", this.downUrl ? '<a href="' + this.downUrl + '" class="res_top_banner_download">立即体验</a>': "", '<i class="c-icon res_top_banner_close"></i>', "</div>"] : ['<div class="res_top_banner_for_win">', '<i class="c-icon ' + (this.hintIcon ? this.hintIcon: "res_top_banner_icon") + '"></i>', "<span>" + this.hintText + "</span>", this.downUrl ? '<a href="' + this.downUrl + '" class="res_top_banner_download">立即体验</a>': "", '<i class="c-icon res_top_banner_close"></i>', "</div>"]),
    ...
    this.bindEvent = function() {
        if ("WIN" !== this.bannerType) {
            ...
            t = this;
            $(".res_top_banner_download", e).on("mousedown",
            function() {
            ...
            $(".res_top_banner_close", e).on("mousedown",
            function() {
                e.detach(),
                t.hintCookie && $.setCookie(t.hintCookie, 5, {
                    expires: 2592e6
...
bds.se.safeTip = function() {
    function e() {
        ...
        $(".unsafe_ico_new").each(function(t, o) {
            n.push(o.getAttribute("data-id")),
            i = o.getAttribute("data-tpl");
            var s = $(o).attr("data-href"),
            r = $(o).attr("href"),
            a = s ? s: r;
            $("h3 a", $(o).parents(".result")).attr("href", a),
            e++
        }),
        e > 0 && ns_c({
            tab: "safetip",
...
bds.se.trust = function() {
    function e() {
        ...
        $(".c-trust").each(function() {
            ...
            0 == e.parent(".c-icons-inner").length && e.wrap("<span class='c-icons-outer'><span class='c-icons-inner'></span></span>"),
            "baozhang-v" === i ? -1 == $.inArray(t, m) && m.push(this.getAttribute("data_key")) : -1 == $.inArray(t, u) && u.push(this.getAttribute("data_key")),
            -1 == $.inArray(this, p) && p.push(this)
        }),
        require(["plugins/bzPopper"],
        function(e) {
            $(".c-trust-as").each(function() {
                var t = $(this).attr("data-bao"),
                i = "2" === $(this).attr("data-baostatus"),
                n = bds.comm.sampleval || [],
                o = n.indexOf("newicon_behindad_newpop") > -1,
                s = n.indexOf("oldicon_behindad_newpop") > -1,
                r = o || s;
                t && i && r ? $(this).on("mouseenter",
                function() {
                    var i = $(this),
                    n = i.find("i"),
                    s = {
                        ...
                        extra: {
                            expStage: e.preset["EXP_STAGE_" + (o ? 1 : 3)]
                        }
                    };
                    e.showUp(s)
    ...
    function i(e) {
        g = !1,
        0 == e.code && $(p).each(function() {
            var t = this.getAttribute("data_key"),
            i = this.getAttribute("hint-type");
            b = e.data[t],
            b && (h = $(this), !i && b.vstar && b.vstar.hint && b.vstar.hint.length > 0 && (h.html(""), n(b.vstar.hint[0].vlevel, b.vstar.url)), b.medical && (h.html(""), s()), "baozhang-v" == i && b.brand && (h.html(""), o(b.brand.url)), b.aviation && (h.html(""), r()))
        })
    }
    function n(e, t) {
        var i = $("<span>", {
    ...
    function a(e, t, i) {
        ...
        if (e && n) {
            ...
            } else if ("vstar" == t || "baozhang" == t || "baozhang-v" == t || "chengqi" == t || "baozhang-v-auth" == t) var a = "<div class='c-tip-cer hitcon'>";
            else var a = "<div class='c-tip-info hitcon'>";
            if (n.length > 0) {
                a += "<ul>";
            ...
            p.onShow = function() {
                if (A.use("honourCard4",
                function() {}), -1 !== t.indexOf("newBao")) i && $(i).attr("hint-type") && (t = $(i).attr("hint-type")),
                ns_c({
                    ...
                    -1 != a.indexOf("ecard") && setTimeout(function() {
                        A.use("honourCard4",
                        function() {
                            var i = $(p.getDom()).find(".c-trust-ecard4"),
                            a = 0;
                            ...
                            t && (d.type = t),
                            a && (d.bzAppliCounts = a),
                            e.brandName && (d.brandName = e.brandName),
                            e.brandLogo && (d.brandLogo = e.brandLogo),
                            e.brandScope && (d.brandScope = e.brandScope),
                            e.brandRelation && (d.brandRelation = e.brandRelation),
                            e.authBrandName && (d.authBrandName = e.authBrandName),
                            e.authBizScope && (d.authBizScope = e.authBizScope),
                            e.authBizType && (d.authBizType = e.authBizType),
                            A.ui.honourCard4(i, d)
                        })
                    },
                    0)
                }
                setTimeout(function() { - 1 !== t.indexOf("newBao") ? $(".opui-honourCard4-new-bao-style", this.dom).each(function() {
    ...
    function c(e) {
        ...
        t = t.replace("[/url]", "</a>").replace(/\[url ([^\s]*)\]/, "<a href='$1' target='_blank'>"),
        t = t.replace(/\[img ([^\s]*)\]/, "<img src='$1' />"),
        t = t.replace(/\[ecard (-?[\d]{0,3})\]/, "<div class='c-trust-ecard4' value='$1'></div>")
    }
    var d = bds && bds.comm && bds.comm.samContentNewStyle,
    l = 4,
    u = [],
    m = [],
    p = [];
    if (bds.util && bds.util.domain && bds.util.domain.get) var f = bds.util.domain.get("http://tag.baidu.com");
    else var f = "http://tag.baidu.com";
    var h = null,
    b = null,
    g = !1,
    v = null,
...
bds.se.share = function() {
    ...
    o = function() {
        var e = [];
        e.push('<div class="bds_v2_share_box">'),
        e.push('<p class="bds_v2_title">分享至：</p>');
        for (var t = 0,
        o = i.length; o > t; t++) {
            var s = n.replace(/#\{(.+?)\}/g,
            function(e, n) {
    ...
    r = function(e) {
        ...
        s(t),
        e.boxEle.innerHTML = o
    },
    a = function(e) {
        var t = e.boxEle.firstChild;
        "bds_v2_share_box" != t.className && (t = e.boxEle),
        t.addEventListener ? t.addEventListener("click",
        function(t) {
            c(t, e)
        },
        !1) : t.attachEvent && t.attachEvent("onclick",
        function(t) {
            c(t, e)
        })
    },
    c = function(t, i) {
        ...
        if (o) {
            ...
            r = r.substr(1),
            jumpUrl = jumpUrl.substr(1),
            jumpUrl = "http://s.share.baidu.com/?" + jumpUrl;
            var u = "//www.baidu.com/tools?url=" + encodeURIComponent(i.url) + "&jump=" + encodeURIComponent(jumpUrl) + "&key=url";
            "weixin" === o ? ($(".c-tip-close").click(), d(i.url)) : window.open(u, "bdShare", "toolbar=0, scrollbars=1, status=0, resizable=1, height=400, width=600"),
            l(e + "/commit?" + r),
    ...
    d = function(e) {
        ...
        a = function() {
            t.find(".bd_weixin_popup_close").click(o),
            $("body").on("keydown",
            function(e) {
                27 == e.keyCode && o()
            }),
        ...
        c = function(e) {
            ...
            l = function(e) {
                ...
                for (var i = ['<table style="direction:ltr;border: 0;border-collapse: collapse;background-color:#fff;margin:0 auto;" align="center">'], n = 0, o = e.length; o > n; n++) {
                    i.push("<tr>");
                    for (var s = 0,
                    r = e[n].length; r > s; s++) i.push('<td style="width:4px;height:4px;padding:0;margin:0;border:none;background:#' + (e[n][s] ? "000": "FFF") + '"></td>');
                    i.push("</tr>")
                }
                return i.push("</table>"),
                i.join("")
            ...
            var f = {
                ...
                getLostPoint: function(e) {
                    for (var t = e.getModuleCount(), i = 0, n = 0; t > n; n++) for (var o = 0; t > o; o++) {
                        for (var s = 0,
                        r = e.isDark(n, o), a = -1; 1 >= a; a++) if (! (0 > n + a || n + a >= t)) for (var c = -1; 1 >= c; c++) 0 > o + c || o + c >= t || (0 != a || 0 != c) && r == e.isDark(n + a, o + c) && s++;
                        s > 5 && (i += 3 + s - 5)
                    }
                    ...
                    for (var l = 0,
                    o = 0; t > o; o++) for (var n = 0; t > n; n++) e.isDark(n, o) && l++;
            ...
            s.getRSBlocks = function(e, t) {
                ...
                o = new Array,
                r = 0; n > r; r++) for (var a = i[3 * r + 0], c = i[3 * r + 1], d = i[3 * r + 2], l = 0; a > l; l++) o.push(new s(c, d));
                return o
            },
            ...
            c.prototype = {
                    ...
                    if (this.typeNumber < 1) {
                        ...
                        for (e = 1; 40 > e; e++) {
                            ...
                            for (var r = 0; r < this.dataList.length; r++) {
                                ...
                                i.put(a.mode, 4),
                                i.put(a.getLength(), f.getLengthInBits(a.mode, e)),
                                a.write(i)
                            }
                ...
                getBestMaskPattern: function() {
                    ...
                    i = 0; 8 > i; i++) {
                        this.makeImpl(!0, i);
                        var n = f.getLostPoint(this); (0 == i || e > n) && (e = n, t = i)
                    }
                    return t
                },
                createMovieClip: function(e, t, i) {
                    ...
                    o = 1;
                    this.make();
                    for (var s = 0; s < this.modules.length; s++) for (var r = s * o,
                ...
                setupTypeInfo: function(e, t) {
                    ...
                    n = f.getBCHTypeInfo(i), o = 0; 15 > o; o++) {
                        var s = !e && 1 == (n >> o & 1);
            ...
            c.createData = function(e, t, i) {
                for (var n = s.getRSBlocks(e, t), r = new o, a = 0; a < i.length; a++) {
                    var d = i[a];
                    r.put(d.mode, 4),
                    r.put(d.getLength(), f.getLengthInBits(d.mode, e)),
                    d.write(r)
                }
                for (var l = 0,
                a = 0; a < n.length; a++) l += n[a].dataCount;
            ...
            c.createBytes = function(e, t) {
                ...
                o = 0,
                s = 0,
                r = new Array(t.length), a = new Array(t.length), c = 0; c < t.length; c++) {
                    var d = t[c].dataCount,
                    l = t[c].totalCount - d;
                    o = Math.max(o, d),
                    s = Math.max(s, l),
                    ...
                    n += d;
                    var m = f.getErrorCorrectPolynomial(l),
                    p = new i(r[c], m.getLength() - 1),
                    h = p.mod(m);
                ...
                for (var g = 0,
                u = 0; u < t.length; u++) g += t[u].totalCount;
...
function() {
    ...
    r = !1; (s.indexOf("msie") >= 0 || new RegExp("trident(.*)rv.(\\d+)\\.(\\d+)").test(s)) && (r = !0);
    var a, c = !1,
...
bds.se.upn = {
    ...
    run: function() {
        ...
        try {
            for (var t = "",
            i = 0; i < e.cookieset.length; i++) if (e.cookieset[i] && e.cookieset[i].k && e.cookieset[i].v) {
...
bds.se.upn.set(function() {
    function e() {
        return n.indexOf("lbbrowser") > 0 ? n.match(/lbbrowser/gi) : n.indexOf("maxthon") > 0 ? n.match(/maxthon\/[\d.]+/gi) : n.indexOf("bidubrowser") > 0 ? n.match(/bidubrowser/gi) : n.indexOf("baiduclient") > 0 ? n.match(/baiduclient/gi) : n.indexOf("metasr") > 0 ? n.match(/metasr/gi) : n.indexOf("qqbrowser") > 0 ? n.match(/qqbrowser/gi) : !
        function() {
    ...
    e.prototype = {
        setCommLog: function(e, t, i) {
            ...
            if (! (e in this.commLog)) {
                var n = {};
                t && i ? (n.log = t, n.len = i) : (n.log = "&q=" + bds.comm.queryEnc + "&qid=" + bds.comm.qid + "&rsv_did=" + bds.comm.did + "&rsv_tn=" + bds.comm.tn + "&rsv_sid=" + bds.comm.sid, n.len = (n.log + "&t=" + (new Date).getTime()).length),
                this.commLog[e] = n
            }
            return ! 0
        },
        fb: function() {
            ...
            return e = 0 === t || 1 === t ? 3e3: this.heartTime[t - 1] + this.heartTime[t - 2],
            this.heartTime.push(e),
            e
        },
        ...
        preInit: function() {
            ...
            e && (this.setCommLog(e), this.sendNum[e] = 0),
        ...
        flushData: function(e) {
            ...
            this.startSend(this.fetchData(e, !0), !0),
            this.startSend(this.fetchData(e, !0)),
            bds && bds.comm && (1 === bds.comm.logFlagSug || 1 === bds.comm.globalLogFlag) && (null !== this.heartT && (clearTimeout(this.heartT), this.heartT = null), this.sendHeart(e))
        },
        init: function() {
            var e = this;
            e.preInit(),
            $(window).on("swap_begin",
            function() {
                null !== e.t && (clearTimeout(e.t), e.t = null),
                bds && bds.comm && 0 === bds.comm.ishome && (1 === bds.comm.logFlag || 1 === bds.comm.globalLogFlag) && e.isFirst === !1 && e.sendHeart(1)
            }).on("unload",
            function() {
            ...
            function() {
                e.preInit(),
                e.isFirst === !0 && (e.isFirst = !1),
                !e.hostAddr[0] && bds && bds.comm && bds.comm.ubsurl && (e.hostAddr[0] = bds.comm.ubsurl + "?")
            })
        },
        ...
        send: function(e, t, i) {
            ...
            return a.src = this.hostAddr[t] + o,
            !0
        },
        ...
        pushData: function(e, t, i) {
            ...
            if (!n) return ! 1;
            i && i.qid && i.log && i.len ? (this.setCommLog(i.qid, i.log, i.len), n = i.qid) : this.setCommLog(n),
            n in this.dataStore || (this.dataStore[n] = {});
        ...
        fetchData: function(e, t) {
            function i() {
                for (var t, i = 0,
                n = [], s = !1, d = this.commLog[l].len, m = this.hostAddr[a].length, p = m + ("type=" + e + "&fm=" + u + "&data=").length + d, f = p + 6, h = f; 0 !== o.length && i < this.MAX_SEND;) c === !1 && 0 === e && i++,
                t = o.shift(),
                n.push(t),
                h = f + t.length + 3,
                (f >= this.MAX_LEN || h >= this.MAX_LEN) && (n.length >= 2 && (n.pop(), s = !0), r.push({
                    qid: l,
                    key: u,
                    type: e,
                    data: "%5B" + n.join("%2C") + "%5D",
                    host: a
                }), n = [], s && (n[0] = t, s = !1), h = n.length > 0 ? p + 3 + t.length + 3 : p + 6),
                f = h;
                n.length > 0 && r.push({
                    qid: l,
                    key: u,
        ...
        startCycle: function() {
            var e = this;
            null === e.cycle && (e.cycle = 1),
            e.t = setTimeout(function() {
                var t = e.fetchData(0),
                i = t.length; - 1 === e.storeLen && (e.storeLen = i),
                0 !== e.storeLen && i / e.storeLen >= 2 && e.curSpeed > e.MIN_SPEED && (e.curSpeed -= 1e3),
                (0 === i || e.storeLen / i >= 2) && e.curSpeed < e.MAX_SPEED && (e.curSpeed += 1e3),
                e.startSend(t, 0),
                e.startCycle()
            },
            e.curSpeed)
...
function() {
    ...
    bds.comm.feedback = 1,
    bds.comm.feedback ? e() ? $(document).delegate(".feedback", "click",
    function() {
        var e = this;
    ...
    t.length ? $(t).val(bds.comm.encTn) : $("#form").append('<input type="hidden" name="rsv_t" value="' + bds.comm.encTn + '"/>'),
...
define("plugins/title_highlight", ["require"],
function() {
    function e() {
        var e = ".c-container",
        t = ".t",
        ...
        $(".c-showurl").hover(function() {
            ...
            o.addClass(i),
            o.find("em").addClass(n)
        },
        function() {
            var o = $(this.parentNode).parents(e).find(t).children(":first");
            o.removeClass(i),
            o.find("em").removeClass(n)
        })
    }
    return {
        init: e
...
$.ajax({
    dataType: "script",
    cache: !0,
    url: "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/home/js/nu_instant_search_6cfa56d.js"
}),
window.PRE_CONN = function() {
    ...
    o = function() {
        try {
            window.pageState && 0 != window.pageState && 1 != i || ($("#kw1,#kw").one("keydown",
            function() {
...
function() {
    ...
    function(e, t, i) {
        ...
        e.parts && i.parts(e.parts),
        e.converters["* parts"] = function(e) {
            return e
        }
    }),
    $.ajaxTransport("parts",
        ...
        if (!e.crossDomain || support.cors) {
            ...
            return {
                send: function(i, n) {
                    ...
                    t = function(i, o) {
                        var r, a, c;
                        if (3 !== s.readyState && 4 !== s.readyState || o || !
                        function() {
                            var t = e.delimiter,
                            i = "";
                            try {
                        ...
                        } (), t && (o || 4 === s.readyState)) if (t = void 0, s.onreadystatechange = jQuery.noop, o) 4 !== s.readyState && s.abort();
                        else {
                            c = {},
                            r = s.status,
...
function() {
    ...
    function writeCookie() {
        if (options.hasOwnProperty("sugSet")) {
            ...
            clearCookie("sug"),
            Cookie.set("sug", e, document.domain, "/", expire30y)
        }
        if (options.hasOwnProperty("sugStoreSet")) {
            var e = 0 == options.sugStoreSet ? "0": "1";
            clearCookie("sugstore"),
            Cookie.set("sugstore", e, document.domain, "/", expire30y)
        }
        if (options.hasOwnProperty("isSwitch")) {
            ...
            clearCookie("ORIGIN"),
            Cookie.set("ORIGIN", e, document.domain, "/", expire30y)
        }
        if (options.hasOwnProperty("imeSwitch")) {
            var e = options.imeSwitch;
            clearCookie("bdime"),
            Cookie.set("bdime", e, document.domain, "/", expire30y)
        }
    }
    function writeBAIDUID() {
        var e, t, i, n = Cookie.get("BAIDUID");
        /FG=(\d+)/.test(n) && (t = RegExp.$1),
        /SL=(\d+)/.test(n) && (i = RegExp.$1),
        /NR=(\d+)/.test(n) && (e = RegExp.$1),
        options.hasOwnProperty("resultNum") && (e = options.resultNum),
        options.hasOwnProperty("resultLang") && (i = options.resultLang),
        Cookie.set("BAIDUID", n.replace(/:.*$/, "") + ("undefined" != typeof i ? ":SL=" + i: "") + ("undefined" != typeof e ? ":NR=" + e: "") + ("undefined" != typeof t ? ":FG=" + t: ""), ".baidu.com", "/", expire30y, !0)
    }
    function clearCookie(e) {
        Cookie.clear(e, "/"),
        Cookie.clear(e, "/", document.domain),
        Cookie.clear(e, "/", "." + document.domain),
        Cookie.clear(e, "/", ".baidu.com")
    }
    function reset(e) {
...
bds.se.speedMonitor = function(e) {
    function t() {
        var e = d.pop();
        e && i(e),
        a && (c = window.setTimeout(t, r))
    }
    function i(e) {
        var t = e.url,
        i = e.size || -1,
        n = [];
        n.push("id=" + encodeURIComponent(e.id)),
        n.push("name=" + encodeURIComponent(e.name)),
        n.push("url=" + encodeURIComponent(e.url)),
        n.push("size=" + encodeURIComponent(e.id));
            ...
            timefilterTip = new bds.se.tip({
                ...
                onShow: function() {
                    ...
                    function(e) {
                        ...
                        r = o.find("input[name='et']");
                        $(t).attr("data-value") && n.setTime($(t).attr("data-value")),
                        $(t).parents(".c-tip-custom").find(".c-tip-custom-input").removeClass("c-tip-custom-input-focus"),
                        $(t).addClass("c-tip-custom-input-focus"),
                        0 == $("#c-tip-custom-calenderCont").length && $(t).parents(".c-tip-custom").append("<div id='c-tip-custom-calenderCont'></div>"),
                        ...
                        }) : (i = new WCal(a), n && i.setDay(formatDate(n),
                        function(e) {
                            e.className += " op_mon_day_selected"
                        })),
                    ...
                    function() {
                        function e(e) {
                            ...
                            n = new Date(0 / 0),
                            o = i.exec(e);
                            return o && (t = +o[2], n.setFullYear(o[1], t - 1, o[3]), t != n.getMonth() + 1 && n.setTime(0 / 0)),
                            n
                        }
                        var t = this,
                        i = e($(t).val());
                    ...
                    try {
                        ...
                        function(e) {
                            ...
                            n > o || n > bds.comm.serverTime ? ($(".c-tip-timerfilter-custom-error").show(), void e.stopPropagation()) : (0 == n && 0 == o && (n = "", o = ""), $(".c-tip-timerfilter-custom-error").hide(), void advChangeUrl("gpc", "stf=" + n + "," + o + "|stftype=2", "自定义时间:" + n + "|" + o, 5))
                        })
                    } catch(e) {}
                }
            }),
...
function() {
    function e() {
        ...
        i = {},
        n = $("#wrapper");
        return t.topResult = n.find("#con-at").find(".result-op"),
        t.rightResult = n.find("#con-ar").find(".result-op"),
        t.leftResult = n.find("#content_left").find(".result, .result-op"),
        t.topResult.length && (i.T = [], t.topResult.each(function() {
            i.T.push(e("T", $(this)))
        })),
    ...
    bds.se.skeleton = function() {
        var t;
        return function() {
            return t || (t = e(), $(window).one("swap_begin",
            function() {
                t = null
            })),
            t
...
function() {
    ...
    e.prototype = {
        init: function() {
            ...
            var t = $("#wrapper");
            e.dom.rsResult = t.find("#rs a"),
            e.dom.hintResult = t.find(".se_common_hint"),
            e.rs = e.dom.rsResult.length || 0,
            e.hint = e.dom.hintResult.length || 0,
            e.display.base = e.getBase(),
            e.dom.L && e.getResult(e.dom.L),
            e.dom.R && e.getResult(e.dom.R),
            e.dom.T && e.getResult(e.dom.T),
            e.rs && (e.display.rs = e.getRS()),
            e.hint && (e.display.hint = e.getHint()),
            e.send()
        },
        send: function() {
            var e = this;
            for (var t in e.display) {
                var i = {};
                i[t] = e.display[t],
                bds.log.send.sendPack("new_disp", i)
            }
        ...
        getBase: function() {
            var e = this,
            t = {};
            return t.qid = bds.comm.qid || "",
            t.tpl = bds.comm.resTemplateName || "",
            t.async = bds.comm.supportis ? 1 : 0,
            t.page = bds.comm.pageNum || 1,
            t.upn = $.getCookie("BD_UPN") || "",
            e.dom.L && (t.left = e.dom.L.length),
            e.dom.R && (t.right = e.dom.R.length),
            e.dom.T && (t.top = e.dom.T.length),
            t.size = {},
            t.size.doc = {
                w: $(document).width(),
                h: $(document).height()
        ...
        getHint: function() {
            ...
            t = {};
            return t.result = [],
            e.dom.hintResult.each(function() {
                var e = {};
                e.id = this.getAttribute("data-id") || 0,
                e.tpl = this.getAttribute("data-tpl") || "",
                t.result.push(e)
            }),
            t
        },
        getResult: function(e) {
            ...
            i = e,
            n = 0,
            o = Math.min(i.length, 10); o > n; n++) {
                var s = i[n].id,
                r = t.getResultDisplay(i[n]);
                t.expand[s] = r.expand,
                delete r.expand,
                t.display[s] = r
            }
        ...
        getResultDisplay: function(e) {
            ...
            function o() {
                ...
                var t = {};
                return e(".favurl") && (t.fi = 1),
                e(".c-text-public.c-text-mult") && (t.gwi = 1),
                e(".icon-unsafe-icon") && (t.fxi = 1),
                e(".c-icon-v") && (t.vi = 1),
                e(".c-icon-med") && (t.yjji = 1),
                e(".c-icon-air") && (t.hxi = 1),
                e(".c-recommend") && (t.cr = 1),
                t
            }
            function s() {
            ...
            function a() {
                ...
                return t.length ? (t.each(function() {
                    var t = $(this),
                    i = {};
                    i.type = t.is("object") && t.attr("type") && t.attr("type").indexOf("flash") >= 0 ? 1 : t.is("video") ? 2 : t.is("audio") ? 3 : 0,
                    i.size = {
                        w: t.width(),
                        h: t.height()
                    },
    ...
    e.prototype = {
        ...
        bindEvent: function(e) {
            ...
            function(e, i) {
                ...
                o = !1,
                s = null;
                i.dom.bind("mouseenter.useraction",
                function() {
        ...
        collectPoint: function(e) {
            ...
            function i(e) {
                if ("resize" === e) {
                    var t = $(window);
                    return s.windowHeight = t.height(),
                    s.windowWidth = t.width(),
                    {
                        type: "resize",
                        t: (new Date).getTime(),
                ...
                if ("scroll" === e) {
                    var i = $(document);
                    return s.scrollTop = i.scrollTop(),
...
bds.se.recommend = function(e) {
    var t = this;
    t.op = $.extend({},
    t._default, e),
    t.id = t.op.target.attr("id");
    var i = bds.comm.asyncRecFlagMap;
    i && "object" == typeof i && (t.disable = 0 === i[t.id]),
    t.init()
},
bds.se.recommend.prototype = {
    ...
    init: function() {
        ...
        e.doWhat(function() {
            e.__init__ || (bds.se.recommend.prototype.__init__ = !0, e.createRecommDom()),
            e.createArrowDom(),
            e.delay.overArrow = setTimeout(function() {
                var t = e.op.arrowDom.find(".rrecom-btn");
                "none" == t.css("display") && t.show(),
                e.moveArrow(function() {
                    t.addClass("rrecom-btn-hover"),
                    e.showRecommDom()
                })
            },
            100)
    ...
    createArrowDom: function() {
        ...
        if (t.length) e.op.arrowDom = t;
            ...
            e.op.arrowDom = $(i),
            e.op.arrowDom.on("click", ".rrecom-btn",
            function() {
                e.hideRecommDom()
            }),
            e.op.target.css({
    ...
    moveArrow: function(e) {
        ...
        i.right = "l" === bds.comm.containerSize ? t.op.arrowOffset_l: t.op.arrowOffset_s,
        t.op.arrowDom.stop().addClass("rrecom-btn-moving rrecom-btn-click").animate(i, 0,
        function() {
            t.currInstance && t.currInstance !== t && t.currInstance.resetArrow(),
            e()
        })
    },
    log: function(e) {
        ...
        return t.rsv_re_fcurl = m.length ? m.attr("href") : s,
        t.rsv_re_fcurl = t.rsv_re_fcurl || "",
        t.rsv_re_fcurl = encodeURIComponent(t.rsv_re_fcurl),
        c($.extend(t, e))
    },
    getLeftP: function() {
    ...
    asynClkRcmd: function(e) {
        ...
        if (e && e.linkInfo) {
            ...
            if (e.defaultHide, o && o.length && (o.remove(), n.append(t.buildRcmdDom(e))), !n || !n.length) {
                var s = "",
                r = $('<div class="new-pmd"></div>');
                bds && bds.comm && bds.comm.samContentNewStyle ? (s = $('<div class="c-gap-top-xsmall c-recommend recommend-none-border"></div>'), bds.comm.samContentNewStyleG ? s = $('<div class="c-gap-top-xsmall c-recommend recommend-none-border recommend-sample-g"></div>') : bds && bds.comm && bds.comm.samContentNewStyleH && (s = $('<div class="c-gap-top-xsmall c-recommend recommend-none-border recommend-sample-h"></div>'))) : s = $('<div class="c-gap-top c-recommend"></div>'),
                i.find(".c-recommend").hide(),
                s.append(t.buildRcmdDom(e)),
                bds && bds.comm && bds.comm.samContentNewStyle ? (r.append(s), t.op.target.append(r)) : t.op.target.append(s)
            }
        }
    },
    buildRcmdDom: function(e) {
        ...
        for (var o = e.linkInfo,
        s = e.linkInfo2,
        r = encodeURIComponent(bds.comm.query), a = 0, c = o.length; c > a; a++) {
            var d = o[a].txt,
            l = encodeURIComponent(o[a].wd),
            u = o[a].sa,
            m = "c-gap-left";
            0 == a && (m = "");
            var p = "wd=" + l + "&rsv_crq=" + u + "&bs=" + r,
            f = t.buildURL(p);
        ...
        if (e && t) {
            ...
            return n.right_recommends_merge = function(e) {
                function n(t, n) {
                    ...
                    t.list && !t.list.length && (t.list = [t.list]),
                    d += $.format(s, t.subtitle, t.subtitle, $.stringify(u)),
                    ...
                    for (var m = i.op.target.find(".t>a").eq(0), p = m.length ? m.attr("href") : i.op.target.attr("mu"), f = 0, h = t.list.length; h > f; f++) {
                        ...
                        if (f == l) break;
                        f % 4 === 0 && (d += r),
                        bds.util && bds.util.domain && bds.util.domain.get && (o.img = bds.util.domain.get(o.img)),
                        d += $.format(a, g, o.img, o.name, g, $.subByte(o.name, 20), (f + 1) % 4 === 0 ? " c-span-last rrecom-item-rowLast": (f + 1) % 4 === 3 ? " rrecom-item-s": "", $.stringify(b), o.attrpic),
                        d += c,
                        ((f + 1) % 4 === 0 || f == h - 1) && (d += c)
                    }
                    return d += c,
    ...
    render: function(e) {
        for (var t = "",
        i = 0; i < e.length; i++) t += this.renderTpl(e[i].extData.tplt, e[i].tplData);
        var n = this.getLeftP();
        n.fm = "alxr",
        this.recommDom.attr("data-click", $.stringify(n)).find(".rrecom-content").eq(0).empty().append(t),
    ...
    createRecommDom: function() {
        ...
        bds.se.recommend.prototype.recommDom = $(e),
        bds.se.recommend.prototype.cssDom = $(i),
    ...
    setRecommSize: function() {
        ...
        bds.se.recommend.prototype.global.topDom = t,
        ...
        bds.comm.recommends.recommWidth = s.w - o.left - 2,
        this.recommDom.css({
            width: s.w - o.left - 2,
    ...
    bindRecommEvent: function() {
        ...
        function() {
            ...
            if (e.recommDom && "none" !== e.recommDom.css("display")) {
                ...
                i = r.scrollLeft(),
                s -= t,
                t <= o.top - s ? "fixed" === e.recommDom.css("position") && (e.recommDom.css("position", "absolute"), e.recommDom.css("top", o.top)) : "absolute" === e.recommDom.css("position") && (e.recommDom.css("position", "fixed"), e.recommDom.css("top", s));
    ...
    hideRecommDom: function() {
        ...
        e.currInstance && window.clearTimeout(e.currInstance.delay.overArrow),
        e.currInstance && e.currInstance.resetArrow(),
        bds.se.recommend.prototype.currInstance = null
    },
    showRecommDom: function() {
        ...
        e.recommDom.find(".rrecom_content_s").length > 0 ? e.recommDom.find(".rrecom-content").css("width", e.op.container_s - 17 + "px") : e.recommDom.find(".rrecom-content").css("width", e.op.container_l - 17 + "px"),
        bds.se.recommend.prototype.currInstance = e,
        e.render(e.getCacheData())
    },
...
bds.se.asynAds = function(e) {
    ...
    if (t && n && o && i) {
        ...
        function(e, t) {
            t.t = p(t.dom[0]) || "",
            t.u = f(t.dom[0]) || "",
            t.u && !new RegExp("baidu.com").test(t.u) && (m += t.u + ":"),
        ...
        b = u[1],
        g = "";
        h.time && (g += h.t + "@" + h.time, b.time && (g += "," + b.t + "@" + b.time)),
        g && (a += "&rlist=" + encodeURIComponent(g)),
                ...
                if (e && e.results && e.results.length && n.length) {
                    ...
                    function(e, t) {
                        if (t.id == i) {
                            ...
                            o += "<style>" + n.css + "</style>",
                            o += n.html,
                            o += "<script>" + n.js + "</script>"
                        }
                    }),
                    n.html(o),
                    $(document).scrollTop() < n.position().top + n.height() && $(document).scrollTop() + $(window).height() > n.position().top && c({
                        fm: "inlo",
...
function() {
    ...
    function t() {
        d = 1e3 * (new Date).getTime() + Math.round(1e3 * Math.random()) - 149e13,
        c >= .005 && .0051 > c && (n(), o(), s(), r())
    }
    function i() {
                ...
                setTimeout(function() {
                    ...
                    if (a && a.length > 1 && c.closest("#content_left .result .c-abstract,#content_left .result .t").length) {
                        ...
                        t = $.ajax({
                            ...
                            success: function(t) {
                                var i = "";
                                if (t && t.data && t.data.type && t.data.to && "zh" == t.data.to && t.data.result && t.data.result.length && t.data.result != a) if (1 == t.data.type) for (var n = t.data.result,
                                o = 0,
                                s = Math.min(n.length, 2); s > o; o++) i += (0 == o ? "": "<br/>") + (n[o].pre ? n[o].pre + "&nbsp;": ""),
                                i += n[o].cont ? $.subByte(n[o].cont, 46 * (1 == s ? 2 : 1) + 1) : "";
                                ...
                                if (i) {
                                    ...
                                    var d = e.getDom();
                                    d.find(".translateContent").html('<p style="margin:0 8px">' + i + "</p>"),
                                    d.css({
...
function() {
    function e(e) {
        return e = o(e),
        e.attr("id") || e.attr("data-click") && $.parseJSON(e.attr("data-click")).rsv_srcid || e.attr("class") || "-1"
    }
    function t(e) {
        var t = o(e),
        i = t.clone();
        i.unbind(),
        i.children(".fb-list-container").remove(),
        i.children(".fb-list-container-first").remove(),
        i.children(".fb-hint-tip").remove(),
        i.removeAttr("style"),
        i.css("margin", "0"),
        e.append(i),
        e.addClass("fb-list-container-hover")
    }
    function i(e) {
        e.empty(),
        e.removeClass("fb-list-container-hover")
    }
    function n() {
        $(".fb-hint-tip").remove(),
    ...
    function s() {
        ...
        i.append("<div class='fb-list-container' data-html2canvas-ignore='true'></div>"),
        i.each(function() {
            $(this).find(".fb-list-container").css("width", $(this).width() + 20),
            $(this).find(".fb-list-container").css("height", $(this).height() + 10)
        })
    ...
    function r(e) {
        var t = "";
        t = t + '<input type="hidden" class="fb-select-value"  name="type" value="' + e[0].key + '">',
        t = t + '<div class="fb-select"><div class="fb-select-shorter"><div class="fb-type-selected">' + e[0].value + '<div class="fb-select-icon"></div></div><div class="fb-type-container">';
    ...
    function a(e, t, i, o) {
        this.init = function() {
            ...
            this.time = i.getFullYear() + "/" + (i.getMonth() + 1) + "/" + i.getDate() + " " + i.getHours() + ":" + i.getMinutes() + ":" + i.getSeconds(),
            this.username = bds.comm.username || "",
            this.order = t && t.attr("id") || "",
            this.entry = "1",
            this.build(),
            this.bindEvent(),
            this.render(),
        ...
        this.build = function() {
            ...
            m.id = "fb_baidu_right_dialog",
            m.className = "fb-feedback-right-dialog",
            m.className = "fb-feedback-right-dialog",
        ...
        this.bindEvent = function() {
            ...
            function() {
                $(e.dom).find(".fb-textarea textarea").val() ? -1 == [27642].indexOf(Number($(e.dom).find(".fb-select-value").val())) || $(e.dom).find(".fb-email").val() ? $(e.dom).find(".fb-email").val() && !/^(\w)+(\.\w+)*@(\w)+((\.\w{2,3}){1,3})$/.test($(e.dom).find(".fb-email").val()) ? ($(e.dom).find(".fb-hint-error-email").css("display", "block"), setTimeout(function() {
                    $(e.dom).find(".fb-hint-error-email").css("opacity", "1"),
                    setTimeout(function() {
                        $(e.dom).find(".fb-hint-error-email").removeAttr("style")
                    },
                    1500)
                },
                50)) : ($(e.dom).find(".fb-modal ").css("display", "none"), $(e.dom).find(".fb-vertify").css("display", "block"), $.getScript("https://wappass.baidu.com/static/machine/js/api/mkd.js",
                function() {
                    var t;
                    ...
                    $(e.dom).find(".fb-hint-no-email").css("opacity", "1"),
                    setTimeout(function() {
                ...
                50)) : ($(e.dom).find(".fb-hint-no-content").css("display", "block"), setTimeout(function() {
                    $(e.dom).find(".fb-hint-no-content").css("opacity", "1"),
                    setTimeout(function() {
            ...
            $(this.dom).find(".fb-checkbox").on("click",
            function(e) {
            ...
            function(t) {
                $(e.dom).find(".fb-type-container").hide(),
                $(e.dom).find(".fb-type-selected").html($(t.currentTarget).text() + "<div class='fb-select-icon'></div>"),
                $(e.dom).find(".fb-select-value").val($(t.currentTarget).attr("value"))
            }),
        ...
        this.post = function(e, t) {
            ...
            var r = 26138,
            a = i.type; ("27642" == this.type || "27643" == this.type || "33081" == this.type) && (r = this.type, a = 0),
            "46918" == i.type && (r = "64637", a = 0),
            "46919" == i.type && (r = "64638", a = 0),
            data = "sug" === o ? {
                product_type: "27642",
                sug_text: i.sugText,
    ...
    function c(e, t) {
        ...
        this.build = function() {
            ...
            s.id = "fb_baidu_list_dialog",
            s.className = "fb-feedback-list-dialog",
            s.setAttribute("data-html2canvas-ignore", "true"),
            s.innerHTML = e,
            this.dom = s,
        ...
        this.bindEvent = function() {
            ...
            function(t) {
                ...
                $(e.dom).find(".fb-type-selected").html($(t.currentTarget).text() + "<div class='fb-select-icon'></div>"),
                $(e.dom).find(".fb-select-value").val($(t.currentTarget).attr("value")),
                33081 == $(t.currentTarget).attr("value") ? $(e.dom).find(".fb-photo-block").css("display", "block") : $(e.dom).find(".fb-photo-block").css("display", "none")
            }),
            $(this.dom).find(".fb-photo-sub-block").on("click",
            function() {
                $(this).addClass("fb-photo-sub-block-hide"),
                $(e.dom).find(".fb-photo-update-hide").removeClass("fb-photo-update-hide"),
                $(e.dom).find(".fb-photo-update-hide").removeClass("fb-photo-update-hide")
            }),
            $(this.dom).find(".fb-photo-update-item-block").on("click",
            function() {
                var t = $(e.dom),
                i = $(this),
                n = $(this).index(),
                ...
                function(e) {
                    ...
                    if (s && ("image/png" == s || "image/jpg" == s || "image/jpeg" == s || "image/jpeg" == s) && $(e.currentTarget).val() && n.size < 2097152) {
                        ...
                        function() {
                            i.find(".fb-photo-update-item-show-img").attr("src", r.result),
                            i.find(".fb-photo-update-item-close").css("display", "block"),
                            i.find(".fb-photo-update-item-show-img").css("display", "block");
            ...
            $(this.dom).find(".fb-photo-update-item-close").on("click",
            function(t) {
                var i = $(e);
                t.stopPropagation();
                var n = $(this).parent(".fb-photo-update-item-block").index();
                $(this).siblings("img").attr("src", ""),
                $(".fb-photo-update-block").find("input").eq(n).val(""),
            ...
            $(this.dom).find(".fb-photo-block-title-ex").on("click",
            function(t) {
                t.stopPropagation(),
                $(e.dom).find(".fb-modal").css("display", "none"),
                $(e.dom).find(".fb-photo-block-example").css("display", "block")
            }),
            $(this.dom).find(".fb-photo-block-example-header img").on("click",
            function(t) {
                t.stopPropagation(),
                $(e.dom).find(".fb-modal").css("display", "block"),
                $(e.dom).find(".fb-photo-block-example").css("display", "none")
            })
        },
        this.render = function() {
            $("body").append(this.dom)
        ...
        this.post = function(e, i) {
            ...
            function() {
                var n = 26138,
                r = o.type; ("27642" == o.type || "27643" == o.type || "33081" == o.type) && (n = o.type, r = 0),
                "46918" == o.type && (n = "64637", r = 0),
                "46919" == o.type && (n = "64638", r = 0),
                data = {
                    product_type: n,
                    content: o.content,
                    type: r,
    ...
    bds && bds.se && (bds.se.ShortCut = {
        ...
        initSugBar: function(e) {
            $(window).scrollTop(0),
            $(".fb-mask").length > 0 && n(),
            bds.se.ShortCut.rdialog = new a("", "", e, "sug"),
            $("#container").append("<div class='fb-mask'></div>"),
            $(".fb-mask").width($("body").width()),
            $(".fb-mask").height($("#wrapper_wrapper").height() > $(window).height ? $("#wrapper_wrapper").height() : $(window).height()),
            $(".fb-mask").on("click",
            function() {
                n(),
                bds.se.ShortCut.ldialog && bds.se.ShortCut.ldialog.destory()
        ...
        init_ala: function(e) {
            ...
            t(e.find(".fb-list-container")),
            bds.se.ShortCut.ldialog = new c(e, 1),
            bds.se.ShortCut.curListDom = e.find(".fb-list-container"),
            $(".fb-mask").on("click",
            function() {
                n(),
                bds.se.ShortCut.ldialog && bds.se.ShortCut.ldialog.destory()
        ...
        init_shade: function() {
            ...
            $(".fb-list-container").hover(function(e) {
                o($(e.currentTarget)),
                $(e.currentTarget).children().length || t($(e.currentTarget))
            },
            function(t) {
        ...
        get_Snapshot: function() {
            ...
            html2canvas(document.body, {
                ...
                onrendered: function(t) {
                    ...
                    n.drawImage(t, 0, 0),
                    bds.se.ShortCut.img_base64 = i.toDataURL("image/png"),
                    $(".fb-canvas-block img").attr("src", i.toDataURL("image/png")),
                    setTimeout(function() {
                    ...
                    function() {
                        ...
                        n = $(window).height();
                        scrollPercent = t / (i - n),
                        $(".fb-canvas-block img").css("top", -(e.canvas_block_height - 172) * scrollPercent)
                    })
                }
            })
        },
        ...
        html2canvas: function() { !
            function(e, t, i) {
                ...
                function o(e, t, i, n, o, s) {
                    ...
                    a = i.width * c,
                    "backgroundSize" !== e && (a -= (s || n).width * c);
                    else if ("backgroundSize" === e) if ("auto" === u[0]) a = n.width;
                    ...
                    return "auto" === u[1] ? r = a / n.width * n.height: -1 !== u[1].toString().indexOf("%") ? (c = parseFloat(u[1]) / 100, r = i.height * c, "backgroundSize" !== e && (r -= (s || n).height * c)) : r = parseInt(u[1], 10),
                    [a, r]
                }
                function s(e, t) {
                    var i = [];
                ...
                var a, c, d = {};
                d.Util = {},
                d.Util.trimText = function(e) {
                    return function(t) {
                        return e ? e.apply(t) : ((t || "") + "").replace(/^\s+|\s+$/g, "")
                    }
                } (String.prototype.trim),
                d.Util.parseBackgroundImage = function(e) {
                    ...
                    p();
                    for (var f = 0,
                    h = e.length; h > f; f++) if (r = e[f], !(0 === u && d.indexOf(r) > -1)) {
                        switch (r) {
                        case '"':
                            a ? a === r && (a = null) : a = r;
                            break;
                ...
                d.Util.getCSS = function(e, n, o) {
                    function s(t, i) {
                        ...
                        s = e.style;
                        return ! /^-?[0-9]+\.?[0-9]*(?:px)?$/i.test(i) && /^-?\d/.test(i) && (n = s.left, o && (e.runtimeStyle.left = e.currentStyle.left), s.left = "fontSize" === t ? "1em": i || 0, i = s.pixelLeft + "px", s.left = n, o && (e.runtimeStyle.left = o)),
                        /^(thin|medium|thick)$/i.test(i) ? i: Math.round(parseFloat(i)) + "px"
                    }
                    ...
                    if (a !== e && (c = t.defaultView.getComputedStyle(e, null)), r = c[n], l) {
                        if (r = (r || "").split(","), r = r[o || 0] || r[0] || "auto", r = d.Util.trimText(r).split(" "), "backgroundSize" !== n || r[0] && !r[0].match(/cover|contain|auto/)) {
                            if (r[0] = -1 === r[0].indexOf("%") ? s(n + "X", r[0]) : r[0], r[1] === i) {
                                if ("backgroundSize" === n) return r[1] = "auto",
                                r;
                                r[1] = r[0]
                            }
                    ...
                    try {
                        t = e.nodeName && "IFRAME" === e.nodeName.toUpperCase() ? e.contentDocument || e.contentWindow.document: function(e) {
                            ...
                            function(e, t) {
                                var n = e.length,
                                o = 0;
                                if ("number" == typeof t.length) for (var s = t.length; s > o; o++) e[n++] = t[o];
                        ...
                        n("html2canvas.Util.Children failed with exception: " + o.message),
                        t = []
                    }
                    return t
                },
                d.Util.Font = function() {
                    ...
                    return function(t, n, o) {
                        ...
                        var s, r, a, c = o.createElement("div"),
                ...
                function() {
                    ...
                    d.Generate.parseGradient = function(t, i) {
                        ...
                        case "-o-linear-gradient":
                            ...
                            if (null === n.x0 && null === n.x1 && (n.x0 = n.x1 = i.width / 2), null === n.y0 && null === n.y1 && (n.y0 = n.y1 = i.height / 2), a = s[3].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\)(?:\s\d{1,3}(?:%|px))?)+/g)) for (c = a.length, d = 1 / Math.max(c - 1, 1), o = 0; c > o; o += 1) l = a[o].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\s*(\d{1,3})?(%|px)?/),
                            l[2] ? (r = parseFloat(l[2]), r /= "%" === l[3] ? 100 : i.width) : r = o * d,
                            n.colorStops.push({
                                color: l[1],
                                stop: r
                            });
                        ...
                        case "-webkit-gradient":
                            ...
                            a = s[3].match(/(\d{1,3})%?\s(\d{1,3})%?,\s(\d{1,3})%?\s(\d{1,3})%?/), a && (n.x0 = a[1] * i.width / 100, n.y0 = a[2] * i.height / 100, n.x1 = a[3] * i.width / 100, n.y1 = a[4] * i.height / 100), a = s[4].match(/((?:from|to|color-stop)\((?:[0-9\.]+,\s)?(?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\)\))+/g)) for (c = a.length, o = 0; c > o; o += 1) l = a[o].match(/(from|to|color-stop)\(([0-9\.]+)?(?:,\s)?((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\)/),
                            r = parseFloat(l[2]),
                            "from" === l[1] && (r = 0),
                            "to" === l[1] && (r = 1),
                            n.colorStops.push({
                        ...
                        case "-moz-linear-gradient":
                            ...
                            a = s[2].match(/(\d{1,3})%?\s(\d{1,3})%?/), a && (n.x0 = a[1] * i.width / 100, n.y0 = a[2] * i.height / 100, n.x1 = i.width - n.x0, n.y1 = i.height - n.y0), a = s[3].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\)(?:\s\d{1,3}%)?)+/g)) for (c = a.length, d = 1 / Math.max(c - 1, 1), o = 0; c > o; o += 1) l = a[o].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\s*(\d{1,3})?(%)?/),
                            l[2] ? (r = parseFloat(l[2]), l[3] && (r /= 100)) : r = o * d,
                            n.colorStops.push({
                                color: l[1],
                                stop: r
                            });
                        ...
                        case "-o-radial-gradient":
                            ...
                            case "":
                                ...
                                m = Math.sqrt(Math.pow(n.cx, 2) + Math.pow(n.y1 - n.cy, 2)),
                                p = Math.sqrt(Math.pow(n.x1 - n.cx, 2) + Math.pow(n.y1 - n.cy, 2)),
                                f = Math.sqrt(Math.pow(n.x1 - n.cx, 2) + Math.pow(n.cy, 2)),
                                n.rx = n.ry = Math.max(u, m, p, f);
                                break;
                            case "closest-corner":
                                u = Math.sqrt(Math.pow(n.cx, 2) + Math.pow(n.cy, 2)),
                                m = Math.sqrt(Math.pow(n.cx, 2) + Math.pow(n.y1 - n.cy, 2)),
                            ...
                            if (a = s[5].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\)(?:\s\d{1,3}(?:%|px))?)+/g)) for (c = a.length, d = 1 / Math.max(c - 1, 1), o = 0; c > o; o += 1) l = a[o].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\s*(\d{1,3})?(%|px)?/),
                            l[2] ? (r = parseFloat(l[2]), r /= "%" === l[3] ? 100 : i.width) : r = o * d,
                            n.colorStops.push({
                                color: l[1],
                                stop: r
                    ...
                    d.Generate.Gradient = function(e, i) {
                        if (0 !== i.width && 0 !== i.height) {
                            var o, s, r, a, c = t.createElement("canvas"),
                            l = c.getContext("2d");
                            if (c.width = i.width, c.height = i.height, o = d.Generate.parseGradient(e, i)) if ("linear" === o.type) {
                                ...
                                p.fillStyle = s,
                                p.fillRect(0, 0, h, h),
                                l.fillStyle = o.colorStops[r - 1].color,
                                l.fillRect(0, 0, c.width, c.height),
                                l.drawImage(m, o.cx - o.rx, o.cy - o.ry, 2 * o.rx, 2 * o.ry)
                            }
                            return c
                        }
                    },
                    ...
                    d.Generate.ListRoman = function(e) {
                        ...
                        for (t = 0; s > t; t += 1) for (; e >= n[t];) e -= n[t],
                        o += i[t];
                        return o
                    }
                } (),
                d.Parse = function(o, a) {
                    ...
                    function b(e, t, i, n) {
                        ...
                        return e.setVariable("fillStyle", n),
                        e.setVariable("font", [ut(t, "fontStyle"), ut(t, "fontVariant"), s, a, r].join(" ")),
                        e.setVariable("textAlign", o ? "right": "left"),
                        "none" !== i ? d.Util.Font(r, a, at) : void 0
                    }
                    ...
                    function v(e, t, i, n) {
                        var o;
                        if (ct.rangeBounds)("none" !== i || 0 !== d.Util.trimText(t).length) && (o = w(t, e.node, e.textOffset)),
                    ...
                    function y(e, t, i) {
                        ...
                        d.Util.trimText(t.nodeValue).length > 0 && (t.nodeValue = p(t.nodeValue, ut(e, "textTransform")), l = l.replace(["-webkit-auto"], ["auto"]), o = t.nodeValue.split(!a.letterRendering && /^(left|right|justify|auto)$/.test(l) && f(ut(e, "letterSpacing")) ? /(\b| )/: ""), n = b(s, e, c, r), a.chinese && o.forEach(function(e, t) { / . * [\u4E00 - \u9FA5]. * $ / .test(e) && (e = e.split(""), e.unshift(t, 1), o.splice.apply(o, e))
                    ...
                    function x(e, t) {
                        ...
                        o.appendChild(at.createTextNode(t)),
                    ...
                    function T(e, t, i) {
                        ...
                        if (/^(decimal|decimal-leading-zero|upper-alpha|upper-latin|upper-roman|lower-alpha|lower-greek|lower-latin|lower-roman)$/i.test(a)) {
                            if (o = C(e, a), s = x(e, o), b(r, e, "none", ut(e, "color")), "inside" !== ut(e, "listStylePosition")) return;
                    ...
                    function I(e, t, i, n, o) {
                        var s = u(t, "paddingLeft"),
                        r = u(t, "paddingTop"),
                        a = u(t, "paddingRight"),
                        c = u(t, "paddingBottom");
                        B(e, i, 0, 0, i.width, i.height, n.left + s + o[3].width, n.top + r + o[0].width, n.width - (o[1].width + o[3].width + s + a), n.height - (o[0].width + o[2].width + r + c))
                    }
                    function L(e) {
                    ...
                    function j(e, t, i, n, o, s, r) {
                        t[0] > 0 || t[1] > 0 ? (e.push(["line", n[0].start.x, n[0].start.y]), n[0].curveTo(e), n[1].curveTo(e)) : e.push(["line", s, r]),
                        (i[0] > 0 || i[1] > 0) && e.push(["line", o[0].start.x, o[0].start.y])
                    }
                    function R(e, t, i, n, o, s, r) {
                        var a = [];
                        return t[0] > 0 || t[1] > 0 ? (a.push(["line", n[1].start.x, n[1].start.y]), n[1].curveTo(a)) : a.push(["line", e.c1[0], e.c1[1]]),
                        i[0] > 0 || i[1] > 0 ? (a.push(["line", s[0].start.x, s[0].start.y]), s[0].curveTo(a), a.push(["line", r[0].end.x, r[0].end.y]), r[0].curveToReversed(a)) : (a.push(["line", e.c2[0], e.c2[1]]), a.push(["line", e.c3[0], e.c3[1]])),
                        t[0] > 0 || t[1] > 0 ? (a.push(["line", o[1].end.x, o[1].end.y]), o[1].curveToReversed(a)) : a.push(["line", e.c4[0], e.c4[1]]),
                        a
                    }
                    function P(e, t, i) {
                        var n = e.left,
                    ...
                    function O(e, t, i, n, o) {
                        var s = ut(e, "backgroundClip"),
                        r = [];
                        switch (s) {
                        case "content-box":
                        case "padding-box":
                            j(r, n[0], n[1], t.topLeftInner, t.topRightInner, o.left + i[3].width, o.top + i[0].width),
                            j(r, n[1], n[2], t.topRightInner, t.bottomRightInner, o.left + o.width - i[1].width, o.top + i[0].width),
                            j(r, n[2], n[3], t.bottomRightInner, t.bottomLeftInner, o.left + o.width - i[1].width, o.top + o.height - i[2].width),
                            j(r, n[3], n[0], t.bottomLeftInner, t.topLeftInner, o.left + i[3].width, o.top + o.height - i[2].width);
                            break;
                        default:
                            j(r, n[0], n[1], t.topLeftOuter, t.topRightOuter, o.left, o.top),
                            j(r, n[1], n[2], t.topRightOuter, t.bottomRightOuter, o.left + o.width, o.top),
                            j(r, n[2], n[3], t.bottomRightOuter, t.bottomLeftOuter, o.left + o.width, o.top + o.height),
                            j(r, n[3], n[0], t.bottomLeftOuter, t.topLeftOuter, o.left, o.top + o.height)
                        }
                        return r
                    }
                    function M(e, t, i) {
                        var n, o, s, r, a, c, d = t.left,
                        l = t.top,
                        u = t.width,
                        m = t.height,
                        p = A(e),
                    ...
                    function q(e, t, i) {
                        "transparent" !== i && (e.setVariable("fillStyle", i), N(e, t), e.fill(), rt += 1)
                    }
                    function U(e, t, i) {
                        ...
                        (/^(submit|reset|button|text|password)$/.test(e.type) || "SELECT" === e.nodeName) && (r.style.lineHeight = ut(e, "height")),
                        r.style.top = t.top + "px",
                        r.style.left = t.left + "px",
                        o = "SELECT" === e.nodeName ? (e.options[e.selectedIndex] || 0).text: e.value,
                        o || (o = e.placeholder),
                        s = at.createTextNode(o),
                        r.appendChild(s),
                        lt.appendChild(r),
                        y(e, s, i),
                        lt.removeChild(r)
                    ...
                    function z(i, o) {
                        ...
                        if (s && s.content && "none" !== s.content && "-moz-alt-content" !== s.content) {
                            ...
                            return l.className = mt + "-before " + mt + "-after",
                            Object.keys(s).filter(H).forEach(function(e) {
                                try {
                                    l.style[e] = s[e]
                                } catch(t) {
                    ...
                    function F(e, t) {
                        var i = z(e, ":before"),
                        n = z(e, ":after"); (i || n) && (i && (e.className += " " + mt + "-before", e.parentNode.insertBefore(i, e), it(i, t, !0), e.parentNode.removeChild(i), e.className = e.className.replace(mt + "-before", "").trim()), n && (e.className += " " + mt + "-after", e.appendChild(n), it(n, t, !0), e.removeChild(n), e.className = e.className.replace(mt + "-after", "").trim()))
                    }
                    function W(e, t, i, n) {
                        var o = Math.round(n.left + i.left),
                        s = Math.round(n.top + i.top);
                        e.createPattern(t),
                        e.translate(o, s),
                        e.fill(),
                        e.translate( - o, -s)
                    ...
                    function G(e, t, i, n, o, s, r, a) {
                        var c = [];
                        c.push(["line", Math.round(o), Math.round(s)]),
                        c.push(["line", Math.round(o + r), Math.round(s)]),
                        c.push(["line", Math.round(o + r), Math.round(a + s)]),
                        c.push(["line", Math.round(o), Math.round(a + s)]),
                        N(e, c),
                        e.save(),
                        e.clip(),
                        W(e, t, i, n),
                    ...
                    function Q(e, t, i, n, o) {
                        var s = d.Util.BackgroundSize(e, t, n, o),
                        r = d.Util.BackgroundPosition(e, t, n, o, s),
                    ...
                    function J(e, t, i) {
                        for (var o, s = ut(e, "backgroundImage"), r = d.Util.parseBackgroundImage(s), a = r.length; a--;) if (s = r[a], s.args && 0 !== s.args.length) {
                            ...
                            o = $(c),
                            o ? Q(e, t, i, o, a) : n("html2canvas: Error loading background:", s)
                        }
                    }
                    function X(e, t) {
                        ...
                        n.height = t.height,
                        i = n.getContext("2d"),
                        B(i, e, 0, 0, e.width, e.height, 0, 0, t.width, t.height),
                        n
                    }
                    function K(e, t, i) {
                        var n = ut(t, "opacity") * (i ? i.opacity: 1);
                        return e.setVariable("globalAlpha", n),
                        n
                    }
                    function Y(e, t, i) {
                        var n = s(t ? i.width: c(), t ? i.height: l()),
                        o = {
                            ctx: n,
                            ...
                            borders: L(e),
                            clip: t && t.clip ? d.Util.Extend({},
                            t.clip) : null
                        };
                        return a.useOverflow === !0 && /(hidden|scroll|auto)/.test(ut(e, "overflow")) === !0 && /(BODY)/i.test(e.nodeName) === !1 && (o.clip = o.clip ? S(o.clip, i) : i),
                    ...
                    function et(e, t, i) {
                        var o, s = d.Util.Bounds(e),
                        r = dt.test(e.nodeName) ? "#efefef": ut(e, "backgroundColor"),
                        a = Y(e, t, s),
                        c = a.borders,
                        l = a.ctx,
                        u = Z(c, s, a.clip),
                        m = M(e, s, c);
                        switch (N(l, m.clip), l.save(), l.clip(), u.height > 0 && u.width > 0 && (V(l, s, r), J(e, u, l)), l.restore(), m.borders.forEach(function(e) {
                            q(l, e.args, e.color)
                        }), i || F(e, a), e.nodeName) {
                        case "IMG":
                    ...
                    function nt(e, t) {
                        function i(e) {
                            var t, n, o, s, a, c = d.Util.Children(e),
                            l = c.length;
                        ...
                        r = "";
                        i(e),
                        n.src = ["data:image/svg+xml,", "<svg xmlns='http://www.w3.org/2000/svg' version='1.1' width='" + o + "' height='" + s + "'>", "<foreignObject width='" + o + "' height='" + s + "'>", "<html xmlns='http://www.w3.org/1999/xhtml' style='margin:0;'>", r.replace(/\#/g, "%23"), "</html>", "</foreignObject>", "</svg>"].join(""),
                        n.onload = function() {
                            t.svgRender = n
                        }
                    }
                    function ot() {
                        var e = et(st, null);
                        return ct.svgRendering && nt(t.documentElement, e),
                        Array.prototype.slice.call(st.children, 0).forEach(function(t) {
                            it(t, e)
                        }),
                        e.backgroundColor = ut(t.documentElement, "backgroundColor"),
                        lt.removeChild(pt),
                        e
                    }
                    bds.se.ShortCut.scrollTop = e.pageYOffset || t.documentElement.scrollTop || t.body.scrollTop,
                    e.scroll(0, 0);
                    var st = a.elements === i ? t.body: a.elements[0],
                    rt = 0,
                    at = st.ownerDocument,
                    ...
                    pt = at.createElement("style");
                    pt.innerHTML = "." + mt + '-before:before { content: "" !important; display: none !important; }.' + mt + '-after:after { content: "" !important; display: none !important; }',
                    lt.appendChild(pt),
                    o = o || {};
                    var ft = function(e) {
                ...
                d.Preload = function(o) {
                    ...
                    function r() {
                        n("html2canvas: start: images: " + _.numLoaded + " / " + _.numTotal + " (failed: " + _.numFailed + ")"),
                        !_.firstRun && _.numLoaded >= _.numTotal && (n("Finished loading images: # " + _.numTotal + " (failed: " + _.numFailed + ")"), "function" == typeof o.complete && o.complete(_))
                    }
                    function a(t, n, s) {
                        var a, c, d = o.proxy;
                        $.href = t,
                        ...
                        s.callbackname = a,
                        d += d.indexOf("?") > -1 ? "&": "?",
                        d += "url=" + encodeURIComponent(t) + "&callback=" + a,
                        c = k.createElement("script"),
                        e[a] = function(t) {
                            "error:" === t.substring(0, 6) ? (s.succeeded = !1, _.numLoaded++, _.numFailed++, r()) : (h(n, s), n.src = t),
                            e[a] = i;
                            try {
                                delete e[a]
                            } catch(o) {}
                    ...
                    function c(t, i) {
                        ...
                        o = n.content;
                        "url" === o.substr(0, 3) && g.loadImage(d.Util.parseBackgroundImage(o)[0].args[0]),
                        p(n.backgroundImage, t)
                    }
                    function l(e) {
                        c(e, ":before"),
                        c(e, ":after")
                    ...
                    function f(e) {
                        ...
                        try {
                            ...
                            t = !1,
                            n("html2canvas: failed to access some element's nodeType - Exception: " + s.message)
                        }
                        if (1 === t || t === i) {
                            l(e);
                            try {
                    ...
                    function h(t, n) {
                        t.onload = function() {
                            n.timer !== i && e.clearTimeout(n.timer),
                            _.numLoaded++,
                            n.succeeded = !0,
                    ...
                    for ($.href = e.location.href, b = $.protocol + $.host, g = {
                        loadImage: function(t) {
                            var n, r;
                            t && _[t] === i && (n = new Image, t.match(/data:image\/.*;base64,/i) ? (n.src = t.replace(/url\(['"]{0,}|['"]{0,}\)$/gi, ""), r = _[t] = {
                                img: n
                            },
                            _.numTotal++, h(n, r)) : s(t) || o.allowTaint === !0 ? (r = _[t] = {
                                img: n
                            },
                            _.numTotal++, h(n, r), n.src = t) : S && !o.allowTaint && o.useCORS ? (n.crossOrigin = "anonymous", r = _[t] = {
                                img: n
                            },
                            _.numTotal++, h(n, r), n.src = t, n.customComplete = function() {
                                this.img.complete ? this.img.onerror() : this.timer = e.setTimeout(this.img.customComplete, 100)
                            }.bind(r), n.customComplete()) : o.proxy && (r = _[t] = {
                                img: n
                            },
                            _.numTotal++, a(t, n, r)))
                        },
                        cleanupDOM: function(s) {
                            ...
                            if (!_.cleanupDone) {
                                ...
                                for (c in _) if (_.hasOwnProperty(c) && (a = _[c], "object" == typeof a && a.callbackname && a.succeeded === i)) {
                                    ...
                                    _.numLoaded++,
                                    _.numFailed++,
                                    n("html2canvas: Cleaned up failed img: '" + c + "' Steps: " + _.numLoaded + " / " + _.numTotal)
                                }
                                e.stop !== i ? e.stop() : t.execCommand !== i && t.execCommand("Stop", !1),
                                t.close !== i && t.close(),
                                _.cleanupDone = !0,
                                s && "string" == typeof s || r()
                            }
                    ...
                    o.timeout > 0 && (w = e.setTimeout(g.cleanupDOM, o.timeout)), n("html2canvas: Preload starts: finding background-images"), _.firstRun = !0, f(x), n("html2canvas: Preload: Finding images"), v = 0; T > v; v += 1) g.loadImage(C[v].getAttribute("src"));
                    return _.firstRun = !1,
                    n("html2canvas: Preload: Done."),
                    _.numTotal === _.numLoaded && r(),
                    g
                },
                ...
                d.Util.Support = function(e, t) {
                    function o() {
                        ...
                        return n("html2canvas: Parse: SVG powered rendering available"),
                        !0
                    }
                    function s() {
                        var e, i, n, o, s = !1;
                        return t.createRange && (e = t.createRange(), e.getBoundingClientRect && (i = t.createElement("boundtest"), i.style.height = "123px", i.style.display = "block", t.body.appendChild(i), e.selectNode(i), n = e.getBoundingClientRect(), o = n.height, 123 === o && (s = !0), t.body.removeChild(i))),
                        s
                    }
                    return {
                        rangeBounds: s(),
                ...
                e.html2canvas = function(t, i) {
                    ...
                    return r = d.Util.Extend(i, r),
                    d.logging = r.logging,
                    r.complete = function(e) { ("function" != typeof r.onpreloaded || r.onpreloaded(e) !== !1) && (o = d.Parse(e, r), ("function" != typeof r.onparsed || r.onparsed(o) !== !1) && (s = d.Renderer(o, r), "function" == typeof r.onrendered && r.onrendered(s)))
                    },
                    e.setTimeout(function() {
                        d.Preload(r)
                    },
                ...
                d.Renderer.Canvas = function(e) {
                    ...
                    return function(e, t, o, s, c) {
                        ...
                        d.clip && (b.save(), b.beginPath(), b.rect(d.clip.left, d.clip.top, d.clip.width, d.clip.height), b.clip()),
                        d.ctx.storage && d.ctx.storage.forEach(a.bind(null, b)),
                        d.clip && b.restore();
                        return n("html2canvas: Renderer: Canvas renderer done - returning canvas obj"),
                        u = t.elements.length,
                        1 === u && "object" == typeof t.elements[0] && "BODY" !== t.elements[0].nodeName ? (f = c.Util.Bounds(t.elements[0]), p = o.createElement("canvas"), p.width = f.width, p.height = f.height, b = p.getContext("2d"), b.drawImage(m, f.left, f.top, f.width, f.height, 0, 0, f.width, f.height), m = null, p) : m
                    }
                }
            } (window, document)
        }
...
define("plugins/safeIcon", ["require"],
function() {
    function e() {
        t(),
        $(document).on("scroll.safeIcon", t)
    }
    function t() {
        u.clear();
    ...
    function s(e) {
        if (!o(e)) return ! 1;
        $(e).attr("data-safe-icon-run", !0),
        $(e).attr("hint-type", "anim-newBao");
        var t = $(e),
...
define("plugins/frontend_sample", ["require"],
function() {
    var e = {};
    return function(t, i) {
...
define("webb/instance", ["require", "@baidu/webb", "webb/instance-config"],
function(e) {
    function t() {
...
define("webb/instance-config", ["require"],
function() {
    var e = {
        "1_3": {
            et_js: {
...
function() {
    return function(e) {
        ...
        function s(e) {
            return Object.keys(e).map(function(t) {
                var i = e[t];
                return void 0 === i ? i = "": "string" != typeof i && (i = JSON.stringify(i)),
        ...
        function h(e, t) { / complete | loaded | interactive / .test(document.readyState) && document.body ? e() : document.addEventListener("DOMContentLoaded",
            function() {
        ...
        t.getProp = r,
        t.getScrollInfo = a,
        t.bindVisibilityChangeEvent = c,
        t.disposeVisibilityChangeEvent = d,
        t.getPageHiddenValue = l,
        t.assign = u,
        t.matchesPolyfill = m,
        t.getUrlFromStyle = p,
        t.isUrl = f,
        t.afterReady = h;
        var g = r(document, "hidden"),
    ...
    function(e, t, i) {
        ...
        t["default"] = {
            initException: function() {
                this.exceptionDim = null,
                this.exceptionInfo = {},
                this.onerrorCb = n.bind(this)
            },
            startJsExceptionLog: function(e, t) {
                this.exceptionInfo = o.assign({},
                e),
                this.exceptionDim = o.assign({},
                t),
                window.removeEventListener("error", this.onerrorCb),
                window.addEventListener("error", this.onerrorCb)
            },
    ...
    function(e, t, i) {
        ...
        t["default"] = {
            sendBaseDispLog: function(e, t, i) {
                ...
                e && (s = n.assign(s, e)),
                this.send("disp_comm", s, t, null, i)
            },
            sendDispLog: function(e, t, i) {
                var o = void 0;
                o = e instanceof Array ? e: n.assign({},
                e),
                this.send("disp_content", o, t, null, i)
            }
        },
        e.exports = t["default"]
    },
    ...
    function(e, t, i) {
        ...
        l = function() {
            function e(t) {
                ...
                this.options.sample && (this.options.curSample = Math.random() < this.options.sample ? 1 : 0),
                this.updateCurSample(),
                this.initException(),
            ...
            },
            {
                key: "updateOption",
                value: function(e) {
                    this.options = r.extend(this.options, e),
                    this.updateCurSample()
                }
            },
            {
            ...
            },
            {
                ...
                value: function(e, t, i, n, o) {
                    if (this.hitSample(e)) {
                        ...
                        r.extend(s, o),
                        s && s.ext ? s.ext.path = location.pathname: s && !s.ext && (s.ext = {
                            path: location.pathname
                        });
                        var a = r.guid(),
                        c = window[a] = new Image;
                        c.onload = function(e) {
                            n && ("function" == typeof n ? n(e) : n.successCb && "function" == typeof n.successCb && n.successCb(e)),
                            delete window[a]
                        },
                        c.onerror = function(e) {
                            n && n.errorCb && "function" == typeof n.errorCb && n.errorCb(e),
                            delete window[a]
                        },
            ...
            },
            {
                ...
                value: function(e, t, i, n) {
                    if (this.hitSample(e)) {
                        ...
                        r.extend(o, n),
                        o && o.ext ? o.ext.path = location.pathname: o && !o.ext && (o.ext = {
                            path: location.pathname
                        }),
                        navigator.sendBeacon ? navigator.sendBeacon(this.getLogHost(e) + "?" + r.stringify(o)) || this.send(e, t, i) : this.send(e, t, i)
                    }
                }
            },
            {
                key: "destroy",
                value: function() {
                    this.destroyJsException(),
                    this.destroyIaMonitor(),
                    this.destroyMediaTime()
                }
            }]),
            e
        } ();
    ...
    function(e, t, i) {
        ...
        w = n(v),
        _ = i(0);
        _.extend(w["default"].prototype, s["default"]),
        _.extend(w["default"].prototype, a["default"]),
        _.extend(w["default"].prototype, d["default"]),
        _.extend(w["default"].prototype, u["default"]),
        _.extend(w["default"].prototype, p["default"]),
        _.extend(w["default"].prototype, h["default"]),
        _.extend(w["default"].prototype, g["default"]),
        t["default"] = w["default"],
        e.exports = t["default"]
    },
    function(e, t, i) {
        ...
        t["default"] = {
            initIa: function() {
                ...
                this.iaDim = {},
                this.iaSendSwitch = !1,
                this.scrollCb = this.sendScrollLog.bind(this),
                this.resizeCb = this.sendResizeLog.bind(this),
                this.iaVisibilityCb = o.bind(this),
                this.iaHideCb = this.iaHideCb.bind(this),
                this.iaShowCb = this.iaShowCb.bind(this)
            },
            ...
            startCycle: function() {
                ...
                this.iaTimer = setTimeout(function() {
                    var t = e.iaQueue.length; - 1 === e.lastQueueLen ? e.lastQueueLen = t: e.lastQueueLen && t / e.lastQueueLen >= 2 && e.curSpeed > 2e3 ? e.curSpeed -= 1e3: t && e.lastQueueLen / t >= 2 && e.curSpeed < 6e3 ? e.curSpeed += 1e3: !t && e.curSpeed < 6e3 ? e.curSpeed += 1e3: t && !e.lastQueueLen && e.curSpeed > 2e3 ? e.curSpeed -= 1e3: !t && e.curSpeed < 6e3 && (e.curSpeed += 1e3),
                    e.lastQueueLen = t,
                    e.flushIaQueue(),
            ...
            startIaMonitor: function() {
                ...
                if (this.options && this.options.ia) {
                    this.iaDim = s.assign(this.iaDim, e),
                    this.resetIaSwitch(),
                    this.iaShowCb(null, !0),
                    this.removeMonitorEvents(),
                    clearTimeout(this.iaTimer),
                    this.startCycle(),
                    this.monitorItems = r;
                    var t = [];
                    this.options && this.options.ia && this.options.ia.iaMonitorItems ? t = this.options.ia.iaMonitorItems: this.options && this.options.iaMonitorItems && (t = this.options.iaMonitorItems),
                    t && Array.isArray(t) && t.length && (this.monitorItems = t.filter(function(e) {
                        return n(r, e)
                    }), this.monitorItems.length || (this.monitorItems = r)),
            ...
            bindMonitorEvents: function() {
                ...
                n(e, "bf") && (s.getProp(document, "hidden") && s.bindVisibilityChangeEvent(this.iaVisibilityCb), window.addEventListener("beforeunload", this.iaHideCb, !1), window.addEventListener("unload", this.iaHideCb, !1), window.addEventListener("pagehide", this.iaHideCb, !1), window.addEventListener("pageshow", this.iaShowCb, !1)),
                n(e, "scroll") && window.addEventListener("scroll", this.scrollCb),
                n(e, "resize") && window.addEventListener("resize", this.resizeCb)
            },
            removeMonitorEvents: function() {
                window.removeEventListener("scroll", this.scrollCb),
                window.removeEventListener("resize", this.resizeCb),
                s.disposeVisibilityChangeEvent(this.iaVisibilityCb),
                window.removeEventListener("beforeunload", this.iaHideCb, !1),
                window.removeEventListener("unload", this.iaHideCb, !1),
                window.removeEventListener("pagehide", this.iaHideCb, !1),
                window.removeEventListener("pageshow", this.iaShowCb, !1)
            },
            ...
            destroyIaMonitor: function() {
                ...
                this.curSpeed = null,
                this.iaQueue = null,
                this.lastQueueLen = null,
                this.iaDim = null,
                this.scrollCb = null,
                this.resizeCb = null,
                this.pageActiveStatusChangeCb = null
            }
        },
        e.exports = t["default"]
    },
    function(e, t, i) {
        ...
        function o() {
            var e = this.__media__;
            e.sendSwitch = !e.sendSwitch,
            e.continueSwitch = !e.continueSwitch
        }
        function s(e) {
        ...
        t["default"] = {
            initMediaTime: function(e) {
                ...
                e ? i.startTime = e: window.__webbbrige__ && window.__webbbrige__.startTime ? (i.startTime = window.__webbbrige__.startTime, window.__webbbrige__.startTime = null) : i.startTime = Date.now(),
                this.hasMediaInit = !0,
                this.mediaHideCb = a.bind(this),
                this.mediaShowCb = r.bind(this),
                this.mediaVisibilityCb = s.bind(this),
                this.resetMediaSwitch = n.bind(this),
                this.convertMediaSwitch = o.bind(this),
                this.destroyMediaEvent(),
                this.bindMediaEvent()
            },
            reStartMediaTime: function(e) {
                if (!this.hasMediaInit) return void this.initMediaTime();
                var t = this.__media__;
                t.count = e ? 1 : t.count + 1,
                t.startTime = Date.now(),
                this.resetMediaSwitch(),
                this.destroyMediaEvent(),
                this.bindMediaEvent()
            },
            stopMediaTime: function() { ! this.__media__ || this.__media__ && !this.__media__.startTime || (this.mediaHideCb(null, !0), this.destroyMediaEvent(), this.__media__.startTime = null)
            },
            ...
            bindMediaEvent: function() {
                c.getProp(document, "hidden") && c.bindVisibilityChangeEvent(this.mediaVisibilityCb),
                window.addEventListener("beforeunload", this.mediaHideCb, !1),
                window.addEventListener("unload", this.mediaHideCb, !1),
                window.addEventListener("pagehide", this.mediaHideCb, !1),
                window.addEventListener("pageshow", this.mediaShowCb, !1)
            },
            destroyMediaEvent: function() {
                c.disposeVisibilityChangeEvent(this.mediaVisibilityCb),
                window.removeEventListener("beforeunload", this.mediaHideCb, !1),
                window.removeEventListener("unload", this.mediaHideCb, !1),
                window.removeEventListener("pagehide", this.mediaHideCb, !1),
                window.removeEventListener("pageshow", this.mediaShowCb, !1)
            },
            destroyMediaTime: function() {
                this.destroyMediaEvent(),
                this.__media__ = null,
                this.hasMediaInit = !1,
                this.mediaHideCb = null,
                this.mediaShowCb = null,
                this.mediaVisibilityCb = null,
                this.resetMediaSwitch = null,
                this.convertMediaSwitch = null
            }
        },
        e.exports = t["default"]
    }])
}),
define("@searchfe/inject-js/dist/decorators/inject", ["require", "exports", "@searchfe/inject-js/dist/di/dependency"],
function(e, t, i) {
    "use strict";
    function n(e) {
        return function(t, n, o) {
...
define("@searchfe/inject-js/dist/decorators/injectable", ["require", "exports"],
function(e, t) {
    "use strict";
    function i() {}
    Object.defineProperty(t, "__esModule", {
...
define("@searchfe/inject-js/dist/decorators/provider", ["require", "exports"],
function(e, t) {
    "use strict";
    function i(e) {
        Reflect.defineMetadata("molecule:option", {
            type: "provider"
        },
        e)
    }
...
define("@searchfe/inject-js/dist/di/container", ["require", "exports", "tslib", "@searchfe/inject-js/dist/di/provider", "@searchfe/inject-js/dist/di/value-provider-impl", "@searchfe/inject-js/dist/di/service-provider-impl", "@searchfe/inject-js/dist/di/factory-provider-impl", "@searchfe/inject-js/dist/utils/map", "@searchfe/inject-js/dist/di/dependency"],
function(e, t, i, n, o, s, r, a, c) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
    }),
    ...
    var d = function() {
        function e() {
            this.services = [],
            this.providers = new a.Map,
            this.providerClasses = new a.Map
        }
        return e.prototype.getOrCreateProvider = function(e) {
            var t = this,
            n = this.providers.get(e);
            if (n) return n;
            var o = this.providerClasses.get(e);
            if (!o) throw new Error("provider for " + e + " not found");
            var s = o.dependencies().map(function(i) {
                return t.create(i, e)
            });
            return n = new(o.bind.apply(o, i.__spreadArrays([void 0], s))),
            this.providers.set(e, n),
            n
        },
        e.prototype.create = function(e, t) {
            ...
            n = i.create(this, t);
            return this.services.push(n),
            n
        },
        e.prototype.createMolecule = function(e) {
            var t = this,
            n = c.getDependencies(e);
            return new(e.bind.apply(e, i.__spreadArrays([void 0], n.map(function(e) {
                return t.create(e)
            }))))
        },
...
define("@searchfe/inject-js/dist/di/dependency", ["require", "exports"],
function(e, t) {
    "use strict";
    function i(e, t) {
        "function" == typeof t && Reflect.defineMetadata("design:paramtypes", e, t)
    }
    function n(e, t, i) {
    ...
    t.getDependencies = t.setNthDependency = t.setDependencies = void 0,
    t.setDependencies = i,
    t.setNthDependency = n,
    t.getDependencies = o
}),
define("@searchfe/inject-js/dist/di/factory-provider-impl", ["require", "exports", "@searchfe/inject-js/dist/di/dependency"],
function(e, t, i) {
    "use strict";
    function n(e) {
        return function() {
            ...
            return t.prototype.create = function() {
                return this.instance || (this.instance = e.apply(void 0, this.args)),
                this.instance
            },
    ...
    t.createFactoryProvider = void 0,
    t.createFactoryProvider = n
}),
define("@searchfe/inject-js/dist/di/provider", ["require", "exports"],
function(e, t) {
    "use strict";
    function i(e) {
...
define("@searchfe/inject-js/dist/di/service-provider-impl", ["require", "exports", "tslib", "@searchfe/inject-js/dist/di/dependency"],
function(e, t, i, n) {
    "use strict";
    function o(e) {
        return function() {
            ...
            return t.prototype.create = function() {
                return this.instance || (this.instance = new(e.bind.apply(e, i.__spreadArrays([void 0], this.args)))),
                this.instance
            },
            t.dependencies = function() {
    ...
    t.createServiceProvider = void 0,
    t.createServiceProvider = o
}),
define("@searchfe/inject-js/dist/di/value-provider-impl", ["require", "exports"],
function(e, t) {
    "use strict";
    function i(e) {
        return function() {
    ...
    t.createValueProvider = void 0,
    t.createValueProvider = i
}),
define("@searchfe/inject-js/dist/index", ["require", "exports", "@searchfe/inject-js/dist/di/container", "@searchfe/inject-js/dist/decorators/injectable", "@searchfe/inject-js/dist/decorators/inject", "@searchfe/inject-js/dist/decorators/provider", "@searchfe/inject-js/dist/di/dependency"],
function(e, t, i, n, o, s, r) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
    }),
    t.setNthDependency = t.getDependencies = t.setDependencies = t.provider = t.inject = t.injectable = t.Container = void 0,
...
define("@searchfe/inject-js/dist/utils/map", ["require", "exports"],
function(e, t) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
...
define("@searchfe/inject-js", ["@searchfe/inject-js/dist/index"],
function(e) {
    return e
}),
define("modules/comm-api", ["require", "exports", "./window/token", "./comm/comm.service", "./log/log.service"],
function(e, t, i, n, o) {
    "use strict";
    function s(e) {
        e.addValue(i.DOCUMENT, document),
        e.addValue(i.PERFORMANCE, window.performance),
        e.addValue(i.LOCAL_STORAGE, window.localStorage),
        e.addValue(i.NAVIGATOR, window.navigator),
        e.addValue(i.PERF_SYNC_DATA, window.__perf_www_datas),
        e.addService(n.Comm),
        e.addService(o.Log)
    }
    t.__esModule = !0,
...
define("modules/result", ["require", "exports", "@searchfe/inject-js", "./comm-api", "./perf-log/perf-log.service", "./async-cache/async-cache-item.service", "./perf-card-log/perf-card-log.service", "./webb/instance.service", "./webb/config.service", "./webb/config.value", "./molecule/molecule.service"],
function(e, t, i, n, o, s, r, a, c, d, l) {
    "use strict";
    t.__esModule = !0,
    t.ResultModule = void 0;
    var u = function() {
        function e(e) {
            this.container = new i.Container,
            this.serviceList = [],
            this.container.addValue("RESULT_DI", this.container),
            n.addCommApi(this.container),
            this.container.addValue(s.AsyncCacheItem, e),
            this.container.addValue(c.WebbConfig, d.webbConfigValue),
            this.container.addService(a.WebbInstance),
            this.container.addService(o.PerfLog),
            this.container.addService(r.PerfCardLog),
            this.container.addService(l.MoleculeService),
            this.serviceList.push(this.container.create(o.PerfLog)),
            this.serviceList.push(this.container.create(r.PerfCardLog)),
            this.serviceList.push(this.container.create(l.MoleculeService))
        }
        return e.prototype.asyncConfirm = function() {},
        e.prototype.destroy = function() {
            this.serviceList.forEach(function(e) {
                e.destroy && e.destroy()
            })
        },
        e
...
define("modules/page", ["require", "exports", "@searchfe/inject-js", "./comm-api", "./perf-sync-log/perf-sync-log.service", "./webb/instance.service", "./webb/config.service", "./webb/config.value"],
function(e, t, i, n, o, s, r, a) {
    "use strict";
    t.__esModule = !0,
    t.PageModule = void 0;
    var c = function() {
        function e() {
            this.container = new i.Container,
            n.addCommApi(this.container),
            this.container.addValue(r.WebbConfig, a.webbConfigValue),
            this.container.addService(s.WebbInstance),
            this.container.addService(o.PerfSyncLog)
        }
        return e.prototype.domReady = function() {
            this.container.create(o.PerfSyncLog)
        },
...
function(e, t) { ! t && bds && bds.comm && bds.comm.globalLogFlag && 1 == bds.comm.globalLogFlag && (1 == bds.comm.logFlagNoNetwork || 1 == bds.comm.logFlagNoIntegration || (bds.se.displayTime = setTimeout(function() {
        bds && bds.se && bds.se.display(),
        bds.se.displayTime = null
    },
    5e3))),
    !t && bds && bds.se.userAction.collect(),
...
$(window).on("swap_end",
function() {
    bds && bds.comm && bds.comm.sampleval && $.inArray("ZOOM_TEST", bds.comm.sampleval) > -1 ? require(["plugins/zoom_prompt"],
    function(e) {
        e()
    }) : bds && bds.comm && bds.comm.sampleval && $.inArray("ZOOM_COMP", bds.comm.sampleval) > -1 && require(["lib/get_zoom"],
    function(e) {
        var t = e();
        t && 1 != t && ns_c({
            fm: "behs",
...
function() {
    if (bds && bds.comm && bds.comm.sampleval && $.inArray("qrcode", bds.comm.sampleval) > -1) {
        ...
        e.length <= 150 && require(["plugins/pcToWise"],
        function(t) {
            t(e)
        })
    }
...
$(document).ready(function() {
    require(["plugins/frontend_sample"],
    function(e) {
        e("op_https_cert_usable", .001) && require(["plugins/https_useable_sample"],
        function(e) {
            e(document, $)
        })
    }),
    require(["plugins/safeIcon"],
    function(e) {
        e.init()
    })
}),
...
function() {
    ...
    t = e.match(/MSIE\s*(\d+)/),
    i = t && t[1] && +t[1] <= 9;
    i || require(["plugins/swfobject", "soutu/js/tu"],
    function(e, t) {
        if (/^\/imgsearch/.test(location.pathname)) {
            ...
            i.each(function() {
                var e = $(this),
                t = e.attr("tpl");
                "tu_relate_site" === t && (t += "@" + e.find(".op-tu-relate-site-result").length),
                n.push(t)
            }),
            t.log({
...
function() {
    function e(e) {
        ...
        return o.src = i + "/v.gif?pid=201&" + t.join("&"),
        !0
    }
    function t(t) {
        t.log = e,
    ...
    function(e, i) {
        var n = i;
        n && n.support() && (t(n), $(window).on("index_off",
        function() {
            n && n.destroy && (n.destroy(), $("#form .ipt_rec").unbind("click")),
            n = i,
            t(n)
        }))
    })
...
$(window).on("swap_end",
function() {
    require(["plugins/title_highlight"],
    function(e) {
        e.init()
    })
}),
